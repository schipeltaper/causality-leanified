% REFACTOR TWIN -- refactor `total_order_helper` (root: def_3_8).
% The mathematical proof of claim_3_2 is UNCHANGED by the refactor.
% Only the Lean *encoding* of IsTopologicalOrder shifts: the original
% flat 4-way conjunction becomes a nested 2-way conjunction with a
% named `IsTotalOrder` helper for the first three sub-conjuncts.
