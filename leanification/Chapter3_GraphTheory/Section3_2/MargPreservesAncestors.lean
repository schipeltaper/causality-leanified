...
-- REFACTOR-BLOCK-ORIGINAL-BEGIN: comp
...
-- REFACTOR-BLOCK-ORIGINAL-END: comp

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: length_comp
...
-- REFACTOR-BLOCK-ORIGINAL-END: length_comp

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: isDirectedWalk_comp
...
-- REFACTOR-BLOCK-ORIGINAL-END: isDirectedWalk_comp

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: vertices_ne_nil
...
-- REFACTOR-BLOCK-ORIGINAL-END: vertices_ne_nil

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: head_mem_vertices
/-- The source of a walk is in its vertex list. -/
lemma Walk.head_mem_vertices {G : CDMG Node} :
    ∀ {u v : Node} (p : Walk G u v), u ∈ p.vertices
  | _, _, .nil _ _ => by simp [Walk.vertices]
  | _, _, .cons _ _ _ _ => by simp [Walk.vertices]
-- REFACTOR-BLOCK-ORIGINAL-END: head_mem_vertices

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: vertices_comp
...
-- REFACTOR-BLOCK-ORIGINAL-END: vertices_comp

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: source_mem
...
lemma WalkStep.source_mem {G : CDMG Node} {u v : Node}
  ...
  · have h1 := (G.hE_subset ha_E).2
    rw [ha_eq] at h1
    exact Finset.mem_union_right _ h1
-- REFACTOR-BLOCK-ORIGINAL-END: source_mem

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: mem_of_mem_vertices
...
-- REFACTOR-BLOCK-ORIGINAL-END: mem_of_mem_vertices

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: source_in_G_of_directedWalk_pos
...
-- REFACTOR-BLOCK-ORIGINAL-END: source_in_G_of_directedWalk_pos

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: target_in_GV_of_directedWalk_pos
...
-- REFACTOR-BLOCK-ORIGINAL-END: target_in_GV_of_directedWalk_pos

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: target_in_G_of_directedWalk_pos
...
-- REFACTOR-BLOCK-ORIGINAL-END: target_in_G_of_directedWalk_pos
...
-- REFACTOR-BLOCK-ORIGINAL-BEGIN: lt_of_directedWalk_pos
...
-- REFACTOR-BLOCK-ORIGINAL-END: lt_of_directedWalk_pos
...
-- REFACTOR-BLOCK-ORIGINAL-BEGIN: vertices_eq_head_cons_tail
...
-- REFACTOR-BLOCK-ORIGINAL-END: vertices_eq_head_cons_tail

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: tail_vertices_ne_nil_of_pos
...
-- REFACTOR-BLOCK-ORIGINAL-END: tail_vertices_ne_nil_of_pos
...
-- REFACTOR-BLOCK-ORIGINAL-BEGIN: find_first_non_W_directed
  ...
  | @cons u v_end vMid a hStep p' ih =>
      ...
      · -- vMid ∉ W: head := single-edge walk to vMid; tail := p'.
        ...
        · -- LHS: u :: p'.vertices; RHS: [u] ++ p'.vertices.
          ...
          rfl
-- REFACTOR-BLOCK-ORIGINAL-END: find_first_non_W_directed
...
-- REFACTOR-BLOCK-ORIGINAL-BEGIN: length_pos_of_ne
...
-- REFACTOR-BLOCK-ORIGINAL-END: length_pos_of_ne
...
-- REFACTOR-BLOCK-ORIGINAL-BEGIN: reverseDirected
...
-- REFACTOR-BLOCK-ORIGINAL-END: reverseDirected

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: length_reverseDirected
lemma Walk.length_reverseDirected {G : CDMG Node} :
  ...
  | _, _, .cons _ _ _ qv', hqv_dir => by
      ...
      rfl
-- REFACTOR-BLOCK-ORIGINAL-END: length_reverseDirected

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: vertices_reverseDirected
...
-- REFACTOR-BLOCK-ORIGINAL-END: vertices_reverseDirected

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: mkBifurcation
...
-- REFACTOR-BLOCK-ORIGINAL-END: mkBifurcation

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: length_mkBifurcation
...
-- REFACTOR-BLOCK-ORIGINAL-END: length_mkBifurcation

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: vertices_mkBifurcation
...
-- REFACTOR-BLOCK-ORIGINAL-END: vertices_mkBifurcation

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: comp_assoc
...
-- REFACTOR-BLOCK-ORIGINAL-END: comp_assoc

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: isBifurcationDirectedHinge_cons_backward_of_directed
...
-- REFACTOR-BLOCK-ORIGINAL-END: isBifurcationDirectedHinge_cons_backward_of_directed

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: isBifurcationDirectedHinge_comp_reverseDirected_aux
lemma Walk.isBifurcationDirectedHinge_comp_reverseDirected_aux
  ...
  | c, _, .cons vMid a hStep qv', hqv_dir, _, rest, k, hrest => by
      ...
      rw [hidx]
      exact ih
-- REFACTOR-BLOCK-ORIGINAL-END: isBifurcationDirectedHinge_comp_reverseDirected_aux

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: isBifurcationDirectedHinge_mkBifurcation
lemma Walk.isBifurcationDirectedHinge_mkBifurcation
  ...
  | .cons vMid a hStep qv', hqv_dir, _ =>
      ...
      rw [hidx]
      exact ih
-- REFACTOR-BLOCK-ORIGINAL-END: isBifurcationDirectedHinge_mkBifurcation
...
-- REFACTOR-BLOCK-ORIGINAL-BEGIN: vertices_reverse_dropLast
...
-- REFACTOR-BLOCK-ORIGINAL-END: vertices_reverse_dropLast

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: mkBifurcationBidir
...
-- REFACTOR-BLOCK-ORIGINAL-END: mkBifurcationBidir

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: length_mkBifurcationBidir
lemma Walk.length_mkBifurcationBidir
  ...
  omega
-- REFACTOR-BLOCK-ORIGINAL-END: length_mkBifurcationBidir

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: vertices_mkBifurcationBidir
lemma Walk.vertices_mkBifurcationBidir
  ...
  rfl
-- REFACTOR-BLOCK-ORIGINAL-END: vertices_mkBifurcationBidir

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: isBifurcationWithSplit_comp_reverseDirected_bidir_aux
...
lemma Walk.isBifurcationWithSplit_comp_reverseDirected_bidir_aux
  ...
  | c, _, .cons vMid a hStep qv', hqv_dir, _, rest, k, hrest => by
      ...
      rw [hidx]
      exact ih
-- REFACTOR-BLOCK-ORIGINAL-END: isBifurcationWithSplit_comp_reverseDirected_bidir_aux

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: isBifurcationWithSplit_comp_right_directed
...
-- REFACTOR-BLOCK-ORIGINAL-END: isBifurcationWithSplit_comp_right_directed

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: isBifurcationWithSplit_mkBifurcationBidir
...
lemma Walk.isBifurcationWithSplit_mkBifurcationBidir
  ...
  rw [hidx] at ih
  exact ih
-- REFACTOR-BLOCK-ORIGINAL-END: isBifurcationWithSplit_mkBifurcationBidir

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: mkBifurcationBidir_isBifurcation
...
-- REFACTOR-BLOCK-ORIGINAL-END: mkBifurcationBidir_isBifurcation
...
-- REFACTOR-BLOCK-ORIGINAL-BEGIN: exists_arms_of_bifurcation_directed_hinge_strong
...
-- REFACTOR-BLOCK-ORIGINAL-END: exists_arms_of_bifurcation_directed_hinge_strong

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: mkBifurcation_isBifurcationSource
...
lemma Walk.mkBifurcation_isBifurcationSource
  ...
  · -- ∃ i, IsBifurcationDirectedHinge ∧ vertices[i+1]? = some c.
    ...
    · rw [h_mk_vs]
      ...
      simp
-- REFACTOR-BLOCK-ORIGINAL-END: mkBifurcation_isBifurcationSource

-- ## Helpers for sub-claim ii(a): hinge type conversion + bidirected arm extractor.

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: isBifurcationDirectedHingeWithSplit_to_isBifurcationWithSplit
...
-- REFACTOR-BLOCK-ORIGINAL-END: isBifurcationDirectedHingeWithSplit_to_isBifurcationWithSplit

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: isBifurcationSource_to_isBifurcation
...
-- REFACTOR-BLOCK-ORIGINAL-END: isBifurcationSource_to_isBifurcation

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: singleEdge_isBifurcation_of_bidir
...
lemma Walk.singleEdge_isBifurcation_of_bidir {G : CDMG Node}
  ...
  · -- IsBifurcationWithSplit 0: `cons _ _ _ (nil _ _), 0` case requires
    -- `a = (u, v) ∧ a ∈ G.L`.
    exact ⟨rfl, hLR⟩
-- REFACTOR-BLOCK-ORIGINAL-END: singleEdge_isBifurcation_of_bidir

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: exists_arms_of_bifurcation_bidir_hinge_strong
  ...
  | @cons u w vMid a hStep p' ih =>
      ...
      | k+1, .cons vMid' a' hStep' p'', h_bif, h_not_dir =>
          ...
          · -- R.vertices.dropLast ⊆ p.vertices.dropLast.
            ...
            rw [List.dropLast_cons_of_ne_nil hp''_ne]
            exact List.mem_cons.mpr (Or.inr hx_p'_drop)
-- REFACTOR-BLOCK-ORIGINAL-END: exists_arms_of_bifurcation_bidir_hinge_strong
...
-- REFACTOR-BLOCK-ORIGINAL-BEGIN: vertices_getLast
...
-- REFACTOR-BLOCK-ORIGINAL-END: vertices_getLast

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: tail_getLast_of_pos
...
lemma Walk.tail_getLast_of_pos {G : CDMG Node} {u v : Node}
  ...
  | @cons u' v' vMid a hStep p' =>
      ...
      exact Walk.vertices_getLast p'
-- REFACTOR-BLOCK-ORIGINAL-END: tail_getLast_of_pos

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: length_pos_of_isBifurcation
...
lemma Walk.length_pos_of_isBifurcation {G : CDMG Node} {u v : Node}
  ...
  | cons _ _ _ _ => exact Nat.succ_le_succ (Nat.zero_le _)
-- REFACTOR-BLOCK-ORIGINAL-END: length_pos_of_isBifurcation

-- REFACTOR-BLOCK-ORIGINAL-BEGIN: arm_dropLast_in_W
...
lemma Walk.arm_dropLast_in_W {G : CDMG Node} {a b : Node}
  ...
  · rw [List.mem_singleton] at h_eq_b
    ...
    · exact hM_W x h_in_interior
-- REFACTOR-BLOCK-ORIGINAL-END: arm_dropLast_in_W
...
-- are pure structural ports against the typed `refactor_WalkStep`
-- constructors (`.forwardE`/`.backwardE`/`.bidir`) and the new
-- 3-arg `refactor_Walk.cons` cell.  `WalkStep.source_mem` is the only
...
-- obligation.
--
-- The net-new helper `refactor_marginalize_L_iff` at the bottom of this
...
-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: comp (was: refactor_comp)
/-- Concatenate two walks `p : u → v` and `q : v → w` into a walk
`u → w`.  Refactor twin of `Walk.comp` against the typed
`refactor_WalkStep`; the `cons`-cell pattern shifts from
`.cons v a h p` (4 args) to `.cons v s p` (3 args), reflecting
the dropped `(a : Node × Node)` field. -/
def refactor_Walk.refactor_comp {G : refactor_CDMG Node} :
    ∀ {u v w : Node}, refactor_Walk G u v → refactor_Walk G v w → refactor_Walk G u w
  | _, _, _, .nil _ _, q => q
  | _, _, _, .cons v s p, q => .cons v s (p.refactor_comp q)
-- REFACTOR-BLOCK-REPLACEMENT-END: comp

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: length_comp (was: refactor_length_comp)
lemma refactor_Walk.refactor_length_comp {G : refactor_CDMG Node} :
    ∀ {u v w : Node} (p : refactor_Walk G u v) (q : refactor_Walk G v w),
      (p.refactor_comp q).refactor_length = p.refactor_length + q.refactor_length
  | _, _, _, .nil _ _, _ => by
  ...
  | _, _, _, .cons _ _ p, q => by
      simp [refactor_Walk.refactor_comp, refactor_Walk.refactor_length,
            ...
            Nat.add_comm, Nat.add_left_comm]
-- REFACTOR-BLOCK-REPLACEMENT-END: length_comp

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: isDirectedWalk_comp (was: refactor_isDirectedWalk_comp)
/-- Concatenation preserves the directed-walk property.  Refactor port:
under the typed `refactor_WalkStep`, `refactor_IsDirectedWalk` on
`.cons _ (.forwardE _) p` reduces *directly* to `p.refactor_IsDirectedWalk`
— no conjunctive destructuring needed.  The `.backwardE` / `.bidir`
branches are vacuous because `refactor_IsDirectedWalk` returns
`False` there. -/
lemma refactor_Walk.refactor_isDirectedWalk_comp {G : refactor_CDMG Node} :
    ∀ {u v w : Node} (p : refactor_Walk G u v) (q : refactor_Walk G v w),
...
-- REFACTOR-BLOCK-REPLACEMENT-END: isDirectedWalk_comp

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: vertices_ne_nil (was: refactor_vertices_ne_nil)
/-- A walk's vertex list is non-empty (`nil` gives `[v]`, `cons`
prepends). -/
lemma refactor_Walk.refactor_vertices_ne_nil {G : refactor_CDMG Node} :
...
-- REFACTOR-BLOCK-REPLACEMENT-END: vertices_ne_nil

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: head_mem_vertices (was: refactor_head_mem_vertices)
/-- The source of a walk is in its vertex list. -/
lemma refactor_Walk.refactor_head_mem_vertices {G : refactor_CDMG Node} :
    ∀ {u v : Node} (p : refactor_Walk G u v), u ∈ p.refactor_vertices
  | _, _, .nil _ _ => by simp [refactor_Walk.refactor_vertices]
  | _, _, .cons _ _ _ => by simp [refactor_Walk.refactor_vertices]
-- REFACTOR-BLOCK-REPLACEMENT-END: head_mem_vertices

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: vertices_comp (was: refactor_vertices_comp)
lemma refactor_Walk.refactor_vertices_comp {G : refactor_CDMG Node} :
    ∀ {u v w : Node} (p : refactor_Walk G u v) (q : refactor_Walk G v w),
      (p.refactor_comp q).refactor_vertices =
        p.refactor_vertices.dropLast ++ q.refactor_vertices
  | _, _, _, .nil _ _, _ => rfl
  | _, _, _, .cons _ _ p, q => by
      have hne : p.refactor_vertices ≠ [] := refactor_Walk.refactor_vertices_ne_nil p
      simp [refactor_Walk.refactor_comp, refactor_Walk.refactor_vertices,
            refactor_Walk.refactor_vertices_comp p q,
            List.dropLast_cons_of_ne_nil hne]
-- REFACTOR-BLOCK-REPLACEMENT-END: vertices_comp

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: source_mem (was: refactor_source_mem)
/-- The source vertex of a `refactor_WalkStep` lies in `G`.

Refactor port of `WalkStep.source_mem`: signature now takes the
typed step `s : refactor_WalkStep G u v` directly (no stored
...
lemma refactor_WalkStep.refactor_source_mem {G : refactor_CDMG Node}
    {u v : Node} (s : refactor_WalkStep G u v) : u ∈ G := by
  change u ∈ G.J ∪ G.V
  cases s with
...
-- REFACTOR-BLOCK-REPLACEMENT-END: source_mem

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: mem_of_mem_vertices (was: refactor_mem_of_mem_vertices)
/-- Every vertex of a walk lies in the underlying CDMG. -/
lemma refactor_Walk.refactor_mem_of_mem_vertices {G : refactor_CDMG Node} :
    ∀ {u v : Node} (p : refactor_Walk G u v) {x : Node},
      x ∈ p.refactor_vertices → x ∈ G
  | _, _, .nil v hv, x, hx => by
      change x ∈ [v] at hx
      rw [List.mem_singleton] at hx
      exact hx ▸ hv
  | _, _, .cons _ s p', x, hx => by
      change x ∈ _ :: p'.refactor_vertices at hx
      rcases List.mem_cons.mp hx with rfl | h_in
      · exact refactor_WalkStep.refactor_source_mem s
      · exact refactor_Walk.refactor_mem_of_mem_vertices p' h_in
-- REFACTOR-BLOCK-REPLACEMENT-END: mem_of_mem_vertices

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: source_in_G_of_directedWalk_pos (was: refactor_source_in_G_of_directedWalk_pos)
/-- The source of a non-trivial directed walk lies in `G`.

Refactor port: under the typed `refactor_WalkStep`, the cons-cell's
WalkStep tag pins the edge directly — no `obtain ⟨ha_eq, ha_E, _⟩`
destructure needed.  The `.backwardE` / `.bidir` branches are
unreachable on a directed walk (`refactor_IsDirectedWalk` returns
`False` there). -/
lemma refactor_Walk.refactor_source_in_G_of_directedWalk_pos {G : refactor_CDMG Node} :
...
-- REFACTOR-BLOCK-REPLACEMENT-END: source_in_G_of_directedWalk_pos

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: target_in_GV_of_directedWalk_pos (was: refactor_target_in_GV_of_directedWalk_pos)
/-- The target of a non-trivial directed walk lies in `G.V`.

Refactor port: equation-style pattern matching peels both the
`cons`-cell and its `WalkStep` constructor simultaneously, so the
elaborator refines the `refactor_IsDirectedWalk` hypothesis to
`q.refactor_IsDirectedWalk` on the `.forwardE` branch (and to
`False` on the `.backwardE` / `.bidir` branches).  The original's
inner `match q, hq_dir, hlen0 with | .nil _ _, _, _ => ...` is
preserved verbatim. -/
lemma refactor_Walk.refactor_target_in_GV_of_directedWalk_pos {G : refactor_CDMG Node} :
    ∀ {u v : Node} (p : refactor_Walk G u v),
      p.refactor_IsDirectedWalk → p.refactor_length ≥ 1 → v ∈ G.V
  | _, _, .nil _ _, _, hlen => by simp [refactor_Walk.refactor_length] at hlen
  | _, _, .cons _ (.forwardE h_E) q, hdir, _ => by
      by_cases hq_len : q.refactor_length ≥ 1
      · exact refactor_Walk.refactor_target_in_GV_of_directedWalk_pos q hdir hq_len
...
-- REFACTOR-BLOCK-REPLACEMENT-END: target_in_GV_of_directedWalk_pos

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: target_in_G_of_directedWalk_pos (was: refactor_target_in_G_of_directedWalk_pos)
lemma refactor_Walk.refactor_target_in_G_of_directedWalk_pos {G : refactor_CDMG Node} :
    ∀ {u v : Node} (p : refactor_Walk G u v),
      p.refactor_IsDirectedWalk → p.refactor_length ≥ 1 → v ∈ G := by
  intro u v p hdir hlen
  exact Finset.mem_union_right _
    (refactor_Walk.refactor_target_in_GV_of_directedWalk_pos p hdir hlen)
-- REFACTOR-BLOCK-REPLACEMENT-END: target_in_G_of_directedWalk_pos
...
-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: marginalize_L_iff (was: refactor_marginalize_L_iff)
lemma refactor_marginalize_L_iff (G : refactor_CDMG Node) (W : Finset Node) (hW : W ⊆ G.V)
    {s : Sym2 Node} :
    s ∈ (G.refactor_marginalize W hW).L ↔
      ∃ e : Node × Node,
        e.1 ∈ G.V \ W ∧ e.2 ∈ G.V \ W ∧
        e.1 ≠ e.2 ∧ G.refactor_MarginalizationΦL W e.1 e.2 ∧
        s = s(e.1, e.2) := by
  constructor
  · intro hs
...
-- because `refactor_IsDirectedWalk` returns `False` there.
...
lemma refactor_mem_of_mem_marginalize {G : refactor_CDMG Node} {W : Finset Node}
...
/-- A node in `G.refactor_marginalize W hW` is outside `W`
(uses `hJV_disj` to handle the `J`-disjunct).  Refactor port:
marg's `J` is unchanged and `hJV_disj` is a field on
`refactor_CDMG` with the same signature, so the body reads
verbatim. -/
lemma refactor_notW_of_mem_marginalize {G : refactor_CDMG Node} {W : Finset Node}
...
-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: lt_of_directedWalk_pos (was: refactor_lt_of_directedWalk_pos)
/-- Along a non-trivial directed walk in `G`, parent-precedence
plus transitivity force `lt` between source and target.  Refactor
port: pattern-match on the typed `refactor_WalkStep` instead of
destructuring an `Or`-shaped `hdir`.  The `.forwardE` branch
reduces `hdir` directly to `q.refactor_IsDirectedWalk` (no
`ha_eq ▸ ha_E` rewrite needed; the edge `(x, v) ∈ G.E` is the
constructor's payload `h_edge`).  The `.backwardE` / `.bidir`
branches close via `hdir.elim` because `refactor_IsDirectedWalk`
returns `False` there.  `G.Pa` shifts to `G.refactor_Pa`
(definition unchanged modulo CDMG type). -/
lemma refactor_Walk.refactor_lt_of_directedWalk_pos {G : refactor_CDMG Node}
    {lt : Node → Node → Prop}
    (h_trans : ∀ u ∈ G, ∀ v ∈ G, ∀ w ∈ G, lt u v → lt v w → lt u w)
    (h_parent : ∀ v w, v ∈ G.refactor_Pa w → lt v w) :
    ∀ {x y : Node} (p : refactor_Walk G x y),
      p.refactor_IsDirectedWalk → p.refactor_length ≥ 1 → lt x y
  | _, _, .nil _ _, _, hlen => by simp [refactor_Walk.refactor_length] at hlen
  | x, y, .cons v (.forwardE h_edge) q, hdir, _ => by
      ...
      by_cases hq_len : q.refactor_length ≥ 1
      · have hy : y ∈ G :=
          refactor_Walk.refactor_target_in_G_of_directedWalk_pos q hdir hq_len
        have hlt_vy : lt v y :=
          refactor_Walk.refactor_lt_of_directedWalk_pos h_trans h_parent q hdir hq_len
  ...
  | _, _, .cons _ (.backwardE _) _, hdir, _ => hdir.elim
  | _, _, .cons _ (.bidir _) _, hdir, _ => hdir.elim
-- REFACTOR-BLOCK-REPLACEMENT-END: lt_of_directedWalk_pos

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: vertices_eq_head_cons_tail (was: refactor_vertices_eq_head_cons_tail)
/-- Every walk's vertex list factors as `source :: tail`.
Refactor port: cons pattern arity drops from 4 to 3 (no stored
ordered pair `a`). -/
lemma refactor_Walk.refactor_vertices_eq_head_cons_tail {G : refactor_CDMG Node} :
    ∀ {u v : Node} (p : refactor_Walk G u v),
      p.refactor_vertices = u :: p.refactor_vertices.tail
  | _, _, .nil _ _ => rfl
  | _, _, .cons _ _ _ => rfl
-- REFACTOR-BLOCK-REPLACEMENT-END: vertices_eq_head_cons_tail

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: tail_vertices_ne_nil_of_pos (was: refactor_tail_vertices_ne_nil_of_pos)
/-- The vertex list's tail of a walk of length `≥ 1` is non-empty.
Refactor port: cons pattern arity drops from 4 to 3; the tail
walk `p'` is now the third argument of `.cons`. -/
lemma refactor_Walk.refactor_tail_vertices_ne_nil_of_pos {G : refactor_CDMG Node} :
    ∀ {u v : Node} (p : refactor_Walk G u v),
      p.refactor_length ≥ 1 → p.refactor_vertices.tail ≠ []
  | _, _, .nil _ _, h => by simp [refactor_Walk.refactor_length] at h
  | _, _, .cons _ _ p', _ => refactor_Walk.refactor_vertices_ne_nil p'
-- REFACTOR-BLOCK-REPLACEMENT-END: tail_vertices_ne_nil_of_pos

-- ## Batch 3: walk expansion through the marginalised CDMG (original 17).
--
-- `refactor_expand_directed_walk_marginalize` is the refactor port of
-- `expand_directed_walk_marginalize`: lift a directed walk in
-- `G.refactor_marginalize W hW` back to a directed walk in `G`, with
...
-- (i) the `cons` cell now binds `s : refactor_WalkStep G u v` (no
...
--     `refactor_IsDirectedWalk` returns `False` there;
-- (ii) the `obtain ⟨ha_eq, ha_mem, hp'_dir⟩ := hp_dir` destructure
--     collapses: under `.forwardE h_edge`, `hp_dir` is *definitionally*
--     `p'.refactor_IsDirectedWalk`, and the edge witness
--     `h_edge : (u, vMid) ∈ (G.refactor_marginalize W hW).E` is the
--     constructor's payload (no `ha_eq ▸ ha_mem` rewrite needed).
--
-- All walk-algebra helpers (`refactor_comp`, `refactor_length_comp`,
-- `refactor_isDirectedWalk_comp`, `refactor_vertices_ne_nil`,
-- `refactor_vertices_comp`, `refactor_vertices_eq_head_cons_tail`,
-- `refactor_tail_vertices_ne_nil_of_pos`) and the marg-membership
-- helper (`refactor_mem_of_mem_marginalize`) come from Batches 1–2.
...
Four symmetric bounds are provided: on `q.refactor_vertices`, on
`q.refactor_vertices.dropLast`, on `q.refactor_vertices.tail`, and
on the interior `q.refactor_vertices.tail.dropLast`.  The latter two
...
`refactor_WalkStep` constructor at the cons cell.  Only the
`.forwardE` branch survives; `.backwardE` / `.bidir` close via
`hp_dir.elim`.  The `obtain ⟨ha_eq, ha_mem, hp'_dir⟩ := hp_dir`
destructure collapses to a direct `hp_dir : p'.refactor_IsDirectedWalk`. -/
lemma refactor_expand_directed_walk_marginalize {G : refactor_CDMG Node}
    {W : Finset Node} {hW : W ⊆ G.V} :
    ∀ {u v : Node} (p : refactor_Walk (G.refactor_marginalize W hW) u v),
      p.refactor_IsDirectedWalk →
      ∃ (q : refactor_Walk G u v),
        q.refactor_IsDirectedWalk ∧ q.refactor_length ≥ p.refactor_length ∧
        (∀ x ∈ q.refactor_vertices, x ∈ p.refactor_vertices ∨ x ∈ W) ∧
        (∀ x ∈ q.refactor_vertices.dropLast,
          x ∈ p.refactor_vertices.dropLast ∨ x ∈ W) ∧
        (∀ x ∈ q.refactor_vertices.tail,
          x ∈ p.refactor_vertices.tail ∨ x ∈ W) ∧
        (∀ x ∈ q.refactor_vertices.tail.dropLast,
          x ∈ p.refactor_vertices.tail.dropLast ∨ x ∈ W) := by
  intro u v p
  induction p with
  | nil v hv =>
      intro _
      have hv_g : v ∈ G := refactor_mem_of_mem_marginalize hv
      refine ⟨refactor_Walk.nil v hv_g, trivial,
              by simp [refactor_Walk.refactor_length],
              ?_, ?_, ?_, ?_⟩
      · intro x hx
        change x ∈ [v] at hx
        change x ∈ [v] ∨ x ∈ W
  ...
  | @cons u v_end vMid s p' ih =>
      ...
      | forwardE h_edge =>
          ...
          have ha_filter : (u, vMid) ∈
                ((G.J ∪ (G.V \ W)) ×ˢ (G.V \ W)).filter
                  (fun e => G.refactor_MarginalizationΦE W e.1 e.2) := h_edge
          ...
          obtain ⟨q_tail, hq_tail_dir, hq_tail_len, hq_tail_sub,
            ...
            ih hp'_dir
          have hq_edge_vs :
              q_edge.refactor_vertices = u :: q_edge.refactor_vertices.tail :=
            refactor_Walk.refactor_vertices_eq_head_cons_tail q_edge
          have h_qe_tail_ne : q_edge.refactor_vertices.tail ≠ [] :=
            refactor_Walk.refactor_tail_vertices_ne_nil_of_pos q_edge hq_edge_pos
          have h_qt_vs_ne : q_tail.refactor_vertices ≠ [] :=
            refactor_Walk.refactor_vertices_ne_nil q_tail
          have hp'_vs_ne : p'.refactor_vertices ≠ [] :=
            refactor_Walk.refactor_vertices_ne_nil p'
          -- q_edge.refactor_vertices.dropLast = u :: q_edge.refactor_vertices.tail.dropLast.
          have h_qe_drop : q_edge.refactor_vertices.dropLast
              = u :: q_edge.refactor_vertices.tail.dropLast := by
            rw [hq_edge_vs]
            exact List.dropLast_cons_of_ne_nil h_qe_tail_ne
          -- q_edge.refactor_vertices.dropLast is non-empty (its head is u).
          have h_qe_drop_ne : q_edge.refactor_vertices.dropLast ≠ [] := by
            rw [h_qe_drop]; exact List.cons_ne_nil _ _
          refine ⟨q_edge.refactor_comp q_tail,
                  refactor_Walk.refactor_isDirectedWalk_comp
                    q_edge q_tail hq_edge_dir hq_tail_dir,
                  ?_, ?_, ?_, ?_, ?_⟩
          · rw [refactor_Walk.refactor_length_comp]
            change q_edge.refactor_length + q_tail.refactor_length
                ≥ p'.refactor_length + 1
            omega
          · -- (q_edge.refactor_comp q_tail).refactor_vertices ⊆ p.refactor_vertices ∪ W.
            intro x hx
            rw [refactor_Walk.refactor_vertices_comp] at hx
            change x ∈ u :: p'.refactor_vertices ∨ x ∈ W
            rcases List.mem_append.mp hx with hx_edge | hx_tail
            · rw [hq_edge_vs] at hx_edge
              rw [List.dropLast_cons_of_ne_nil h_qe_tail_ne] at hx_edge
              rcases List.mem_cons.mp hx_edge with rfl | hx_in_qe_t_d
            ...
            · rcases hq_tail_sub x hx_tail with h_p' | h_w
              · exact Or.inl (List.mem_cons.mpr (Or.inr h_p'))
              · exact Or.inr h_w
          · -- (q_edge.refactor_comp q_tail).refactor_vertices.dropLast ⊆ p.refactor_vertices.dropLast ∪ W.
            intro x hx
            have h_vs_comp : (q_edge.refactor_comp q_tail).refactor_vertices
                = q_edge.refactor_vertices.dropLast ++ q_tail.refactor_vertices :=
              refactor_Walk.refactor_vertices_comp q_edge q_tail
            rw [h_vs_comp] at hx
            rw [List.dropLast_append_of_ne_nil h_qt_vs_ne] at hx
            change x ∈ (u :: p'.refactor_vertices).dropLast ∨ x ∈ W
            rw [List.dropLast_cons_of_ne_nil hp'_vs_ne]
            rcases List.mem_append.mp hx with hx_edge | hx_tail_drop
            · rw [hq_edge_vs] at hx_edge
              rw [List.dropLast_cons_of_ne_nil h_qe_tail_ne] at hx_edge
            ...
            · rcases hq_tail_drop_sub x hx_tail_drop with h_p' | h_w
              · exact Or.inl (List.mem_cons.mpr (Or.inr h_p'))
              · exact Or.inr h_w
          · -- (q_edge.refactor_comp q_tail).refactor_vertices.tail ⊆ p.refactor_vertices.tail ∪ W.
            intro x hx
            have h_vs_comp : (q_edge.refactor_comp q_tail).refactor_vertices
                = q_edge.refactor_vertices.dropLast ++ q_tail.refactor_vertices :=
              refactor_Walk.refactor_vertices_comp q_edge q_tail
            rw [h_vs_comp] at hx
            rw [List.tail_append_of_ne_nil h_qe_drop_ne] at hx
            -- q_edge.refactor_vertices.dropLast.tail = q_edge.refactor_vertices.tail.dropLast.
            have h_qe_drop_tail :
                q_edge.refactor_vertices.dropLast.tail
                  = q_edge.refactor_vertices.tail.dropLast := by
              rw [h_qe_drop]; rfl
            rw [h_qe_drop_tail] at hx
            -- p.refactor_vertices.tail = p'.refactor_vertices (since p = cons u _ p').
            change x ∈ p'.refactor_vertices ∨ x ∈ W
            rcases List.mem_append.mp hx with hx_qe_inter | hx_qt
            · exact Or.inr (hq_edge_inter x hx_qe_inter)
            · rcases hq_tail_sub x hx_qt with h_p' | h_w
              · exact Or.inl h_p'
              · exact Or.inr h_w
          · -- (q_edge.refactor_comp q_tail).refactor_vertices.tail.dropLast ⊆ p.refactor_vertices.tail.dropLast ∪ W.
            intro x hx
            have h_vs_comp : (q_edge.refactor_comp q_tail).refactor_vertices
                = q_edge.refactor_vertices.dropLast ++ q_tail.refactor_vertices :=
              refactor_Walk.refactor_vertices_comp q_edge q_tail
            ...
            have h_qe_drop_tail :
              ...
              rw [h_qe_drop]; rfl
            rw [h_qe_drop_tail] at hx
            change x ∈ p'.refactor_vertices.dropLast ∨ x ∈ W
            rcases List.mem_append.mp hx with hx_qe_inter | hx_qt_drop
            · exact Or.inr (hq_edge_inter x hx_qe_inter)
            · rcases hq_tail_drop_sub x hx_qt_drop with h_p' | h_w
              · exact Or.inl h_p'
...
-- carrier, produce a directed walk in `G.refactor_marginalize W hW`
...
-- `refactor_WalkStep` constructors.  Only the `find_first_non_W_directed`
...
-- close via `hp_dir.elim` because `refactor_IsDirectedWalk` returns
...
--
-- Marg-E construction sites: `(v₁, m) ∈ (G.refactor_marginalize W hW).E`
...
-- collapses to `hq_tail_dir` (the cons-level `refactor_IsDirectedWalk`
-- on `.forwardE` is *definitionally* the tail's
-- `refactor_IsDirectedWalk`).

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: find_first_non_W_directed (was: refactor_find_first_non_W_directed)
/-- Find the first non-`W` vertex strictly after the source of a
non-trivial directed walk whose target is outside `W`, and split the
walk at that vertex.  Additionally guarantees that
`p.refactor_vertices = head.refactor_vertices.dropLast ++ tail.refactor_vertices`,
i.e.\ the split factors `p` exactly as a `refactor_Walk.refactor_comp`.

Refactor port: signature retargets `Walk` / `CDMG` / `IsDirectedWalk` /
`vertices` / `length` to the `refactor_*` analogues; body case-splits
on the typed `refactor_WalkStep` constructor at the cons cell.  Only
...
`refactor_Walk.cons vMid (.forwardE h_edge) (refactor_Walk.nil vMid hvMid_g)`. -/
lemma refactor_find_first_non_W_directed {G : refactor_CDMG Node} (W : Finset Node) :
    ∀ {u v : Node} (p : refactor_Walk G u v),
      p.refactor_IsDirectedWalk → p.refactor_length ≥ 1 → v ∉ W →
      ∃ (m : Node) (head : refactor_Walk G u m) (tail : refactor_Walk G m v),
        head.refactor_IsDirectedWalk ∧ tail.refactor_IsDirectedWalk ∧
        head.refactor_length ≥ 1 ∧ m ∉ W ∧
        (∀ x ∈ head.refactor_vertices.tail.dropLast, x ∈ W) ∧
  ...
  | @cons u v_end vMid s p' ih =>
      ...
      | forwardE h_edge =>
          ...
          by_cases hvMid_W : vMid ∈ W
          · -- vMid ∈ W: recurse on p'
            have hp'_pos : p'.refactor_length ≥ 1 := by
              by_contra hp'_nonpos
              have hp'_zero : p'.refactor_length = 0 := by omega
              match p', hp'_zero with
              | .nil _ _, _ => exact hv_notW hvMid_W
            obtain ⟨m, head_p', tail, h_head_p'_dir, h_tail_dir, h_head_p'_pos,
                    hm_notW, h_head_p'_inter, h_lens, h_p'_eq⟩ :=
              ih hp'_dir hp'_pos hv_notW
            refine ⟨m, refactor_Walk.cons vMid (.forwardE h_edge) head_p', tail,
                    h_head_p'_dir, h_tail_dir, ?_, hm_notW,
                    ?_, ?_, ?_⟩
            · change head_p'.refactor_length + 1 ≥ 1; omega
            · -- (cons u (.forwardE _) head_p').refactor_vertices.tail.dropLast ⊆ W
              intro x hx
              change x ∈ head_p'.refactor_vertices.dropLast at hx
              rw [refactor_Walk.refactor_vertices_eq_head_cons_tail head_p'] at hx
              have h_tail_ne : head_p'.refactor_vertices.tail ≠ [] :=
                refactor_Walk.refactor_tail_vertices_ne_nil_of_pos head_p' h_head_p'_pos
              rw [List.dropLast_cons_of_ne_nil h_tail_ne] at hx
              rcases List.mem_cons.mp hx with rfl | hx_rest
              · exact hvMid_W
              · exact h_head_p'_inter x hx_rest
            · change head_p'.refactor_length + 1 + tail.refactor_length
                  = p'.refactor_length + 1; omega
            · -- p.refactor_vertices
              -- = (cons _ _ head_p').refactor_vertices.dropLast ++ tail.refactor_vertices
              change u :: p'.refactor_vertices
                    = (u :: head_p'.refactor_vertices).dropLast
                        ++ tail.refactor_vertices
              have h_hp'_ne : head_p'.refactor_vertices ≠ [] :=
                refactor_Walk.refactor_vertices_ne_nil head_p'
              rw [List.dropLast_cons_of_ne_nil h_hp'_ne]
              rw [List.cons_append]
              rw [h_p'_eq]
          · -- vMid ∉ W: head := single-edge walk to vMid; tail := p'.
            ...
            refine ⟨vMid, refactor_Walk.cons vMid (.forwardE h_edge)
                    (refactor_Walk.nil vMid hvMid_g), p',
                    trivial, hp'_dir,
                    by simp [refactor_Walk.refactor_length],
                    hvMid_W, ?_, ?_, ?_⟩
            · intro x hx
              simp [refactor_Walk.refactor_vertices] at hx
            · change 1 + p'.refactor_length = p'.refactor_length + 1; omega
            · -- LHS: u :: p'.refactor_vertices; RHS: [u] ++ p'.refactor_vertices.
              change u :: p'.refactor_vertices = [u] ++ p'.refactor_vertices
              rfl
-- REFACTOR-BLOCK-REPLACEMENT-END: find_first_non_W_directed
...
(the cons-level `refactor_IsDirectedWalk` on `.forwardE` is
definitionally the tail's `refactor_IsDirectedWalk`). -/
lemma refactor_project_directed_walk_aux {G : refactor_CDMG Node} {W : Finset Node}
    {hW : W ⊆ G.V} :
    ∀ (n : ℕ) {v₁ v₂ : Node} (p : refactor_Walk G v₁ v₂),
      p.refactor_length ≤ n →
      p.refactor_IsDirectedWalk →
      v₁ ∈ G.refactor_marginalize W hW →
      v₂ ∈ G.refactor_marginalize W hW →
      ∃ (q : refactor_Walk (G.refactor_marginalize W hW) v₁ v₂),
        q.refactor_IsDirectedWalk := by
  intro n
  induction n with
  | zero =>
      intros v₁ v₂ p hp_len _ hv₁ _
      have hp_zero : p.refactor_length = 0 := by omega
      match p, hp_zero with
      | .nil v _, _ => exact ⟨refactor_Walk.nil v hv₁, trivial⟩
  | succ k ih =>
      intros v₁ v₂ p hp_len hp_dir hv₁ hv₂
      by_cases hp_zero : p.refactor_length = 0
      · match p, hp_zero with
        | .nil v _, _ => exact ⟨refactor_Walk.nil v hv₁, trivial⟩
      · have hp_pos : p.refactor_length ≥ 1 := Nat.one_le_iff_ne_zero.mpr hp_zero
        have hv₂_notW : v₂ ∉ W := refactor_notW_of_mem_marginalize hW hv₂
        obtain ⟨m, head, tail, h_head_dir, h_tail_dir, h_head_pos,
                hm_notW, h_head_inter, h_lens, _⟩ :=
          refactor_find_first_non_W_directed W p hp_dir hp_pos hv₂_notW
        -- m ∈ G.V (target of a directed walk of length ≥ 1).
        have hm_V : m ∈ G.V :=
        ...
        · -- v₁ ≠ m: build a single `marg`-edge from v₁ to m, then
          ...
          have h_edge_marg : (v₁, m) ∈ (G.refactor_marginalize W hW).E := by
            ...
            · -- `Φ_E W v₁ m`: the head walk itself witnesses it.
              exact ⟨head, h_head_dir, h_head_pos, h_head_inter⟩
          exact ⟨refactor_Walk.cons m (.forwardE h_edge_marg) q_tail,
                 hq_tail_dir⟩
...
lemma refactor_project_directed_walk_marginalize {G : refactor_CDMG Node}
    {W : Finset Node} {hW : W ⊆ G.V}
    {v₁ v₂ : Node} (p : refactor_Walk G v₁ v₂) (hp_dir : p.refactor_IsDirectedWalk)
    (hv₁ : v₁ ∈ G.refactor_marginalize W hW)
    (hv₂ : v₂ ∈ G.refactor_marginalize W hW) :
    ∃ (q : refactor_Walk (G.refactor_marginalize W hW) v₁ v₂),
      q.refactor_IsDirectedWalk :=
  refactor_project_directed_walk_aux
    (hW := hW) p.refactor_length p le_rfl hp_dir hv₁ hv₂
...
lemma refactor_project_directed_walk_with_vertex_subset_aux
    ...
    ∀ (n : ℕ) {v₁ v₂ : Node} (p : refactor_Walk G v₁ v₂),
      ...
      ∃ (q : refactor_Walk (G.refactor_marginalize W hW) v₁ v₂),
        ...
        (∀ x ∈ q.refactor_vertices.dropLast, x ∈ p.refactor_vertices.dropLast) ∧
        (∀ x ∈ q.refactor_vertices.tail, x ∈ p.refactor_vertices.tail) := by
  intro n
  induction n with
  | zero =>
      intros v₁ v₂ p hp_len _ hv₁ _
      ...
      match p, hp_zero with
      | .nil v _, _ =>
          refine ⟨refactor_Walk.nil v hv₁, trivial, ?_, ?_, ?_⟩
          · intro x hx
            change x ∈ [v] at hx
            change x ∈ [v]
            exact hx
  ...
  | succ k ih =>
      ...
      · have hp_pos : p.refactor_length ≥ 1 := Nat.one_le_iff_ne_zero.mpr hp_zero
        ...
        obtain ⟨q_tail, hq_tail_dir, hq_tail_sub, hq_tail_drop, hq_tail_tail⟩ :=
          ih tail h_tail_len h_tail_dir hm_marg hv₂
        -- Bookkeeping: head.refactor_vertices
        -- = v₁ :: head.refactor_vertices.tail, with non-empty tail.
        have h_head_drop_ne : head.refactor_vertices.tail ≠ [] :=
            refactor_Walk.refactor_tail_vertices_ne_nil_of_pos head h_head_pos
        have h_head_vs : head.refactor_vertices
            = v₁ :: head.refactor_vertices.tail :=
            refactor_Walk.refactor_vertices_eq_head_cons_tail head
        have h_v1_in_drop : v₁ ∈ head.refactor_vertices.dropLast := by
          rw [h_head_vs]
          rw [List.dropLast_cons_of_ne_nil h_head_drop_ne]
          exact List.mem_cons_self
        have h_head_drop_vs : head.refactor_vertices.dropLast =
            v₁ :: head.refactor_vertices.tail.dropLast := by
          rw [h_head_vs]
          exact List.dropLast_cons_of_ne_nil h_head_drop_ne
        -- p.refactor_vertices.dropLast: derived from
        -- p.refactor_vertices = head.dropLast ++ tail.
        have h_tail_vs_ne : tail.refactor_vertices ≠ [] :=
          refactor_Walk.refactor_vertices_ne_nil tail
        have h_p_drop : p.refactor_vertices.dropLast =
            head.refactor_vertices.dropLast ++ tail.refactor_vertices.dropLast := by
          rw [h_p_eq]
          exact List.dropLast_append_of_ne_nil h_tail_vs_ne
        have h_p_tail : p.refactor_vertices.tail =
            head.refactor_vertices.dropLast.tail ++ tail.refactor_vertices := by
          rw [h_p_eq, h_head_drop_vs]
          rfl
        by_cases hv₁_eq_m : v₁ = m
        · -- Self-loop case: return `q_tail` directly (with `v₁ = m` on
          ...
          subst hv₁_eq_m
          refine ⟨q_tail, hq_tail_dir, ?_, ?_, ?_⟩
          · -- q_tail.refactor_vertices ⊆ p.refactor_vertices.
            intro x hx
            rw [h_p_eq]
            exact List.mem_append.mpr (Or.inr (hq_tail_sub x hx))
          · -- q_tail.refactor_vertices.dropLast ⊆ p.refactor_vertices.dropLast.
            intro x hx
            rw [h_p_drop]
            exact List.mem_append.mpr (Or.inr (hq_tail_drop x hx))
          · -- q_tail.refactor_vertices.tail ⊆ p.refactor_vertices.tail.
            intro x hx
            rw [h_p_tail]
            have hx_t : x ∈ tail.refactor_vertices.tail := hq_tail_tail x hx
            exact List.mem_append.mpr (Or.inr (List.mem_of_mem_tail hx_t))
        · -- Non-self-loop case: build single marg-edge.
          have h_edge_marg : (v₁, m) ∈ (G.refactor_marginalize W hW).E := by
            change (v₁, m) ∈ ((G.J ∪ (G.V \ W)) ×ˢ (G.V \ W)).filter
            ...
            · -- `Φ_E W v₁ m`: the head walk itself witnesses it.
              exact ⟨head, h_head_dir, h_head_pos, h_head_inter⟩
          refine ⟨refactor_Walk.cons m (.forwardE h_edge_marg) q_tail,
                  hq_tail_dir, ?_, ?_, ?_⟩
          · -- q.refactor_vertices ⊆ p.refactor_vertices.
            intro x hx
            change x ∈ v₁ :: q_tail.refactor_vertices at hx
            rw [h_p_eq]
            rcases List.mem_cons.mp hx with hx_v1 | hx_tail
            · subst hx_v1
              exact List.mem_append.mpr (Or.inl h_v1_in_drop)
            · exact List.mem_append.mpr (Or.inr (hq_tail_sub x hx_tail))
          · -- q.refactor_vertices.dropLast ⊆ p.refactor_vertices.dropLast.
            -- q.refactor_vertices = v₁ :: q_tail.refactor_vertices.
            -- q_tail.refactor_vertices is non-empty, so
            -- q.refactor_vertices.dropLast = v₁ :: q_tail.refactor_vertices.dropLast.
            intro x hx
            have h_qt_vs_ne : q_tail.refactor_vertices ≠ [] :=
              refactor_Walk.refactor_vertices_ne_nil q_tail
            change x ∈ (v₁ :: q_tail.refactor_vertices).dropLast at hx
            rw [List.dropLast_cons_of_ne_nil h_qt_vs_ne] at hx
            rw [h_p_drop]
            rcases List.mem_cons.mp hx with hx_v1 | hx_qtl
            · subst hx_v1
              exact List.mem_append.mpr (Or.inl h_v1_in_drop)
            · exact List.mem_append.mpr (Or.inr (hq_tail_drop x hx_qtl))
          · -- q.refactor_vertices.tail ⊆ p.refactor_vertices.tail.
            -- q.refactor_vertices = v₁ :: q_tail.refactor_vertices.
            -- q.refactor_vertices.tail = q_tail.refactor_vertices.
            intro x hx
            change x ∈ q_tail.refactor_vertices at hx
            rw [h_p_tail]
            -- p.refactor_vertices.tail
            -- = head.refactor_vertices.dropLast.tail ++ tail.refactor_vertices.
            -- q_tail.refactor_vertices ⊆ tail.refactor_vertices ⊆ p.refactor_vertices.tail.
            exact List.mem_append.mpr (Or.inr (hq_tail_sub x hx))
...
/-- Convenience wrapper for the strong projection: project a directed
walk `p : refactor_Walk G v₁ v₂` (between marg-nodes of
`G.refactor_marginalize W hW`) to a directed walk
`q : refactor_Walk marg v₁ v₂` with the three vertex-subset
clauses.  Refactor port: pure name retarget. -/
lemma refactor_project_directed_walk_strong {G : refactor_CDMG Node}
    {W : Finset Node} {hW : W ⊆ G.V}
    {v₁ v₂ : Node} (p : refactor_Walk G v₁ v₂) (hp_dir : p.refactor_IsDirectedWalk)
    (hv₁ : v₁ ∈ G.refactor_marginalize W hW)
    (hv₂ : v₂ ∈ G.refactor_marginalize W hW) :
...
-- `refactor_WalkStep` constructors.  The centerpiece is
-- `refactor_reverseDirected` (decl 24): under the refactor the cons-cell's
...
-- `refactor_IsBifurcationDirectedHingeWithSplit` and
-- `refactor_IsDirectedWalk` strip the conjunction structurally.
--
-- Vacuous `.backwardE` / `.bidir` branches discharge via `hqv_dir.elim`
-- (matching the pattern used in Batch 1's `refactor_isDirectedWalk_comp`
-- and `refactor_target_in_GV_of_directedWalk_pos`).

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: length_pos_of_ne (was: refactor_length_pos_of_ne)
/-- A walk between distinct endpoints has length `≥ 1`. -/
lemma refactor_Walk.refactor_length_pos_of_ne {G : refactor_CDMG Node} {u v : Node}
    (p : refactor_Walk G u v) (h : u ≠ v) : p.refactor_length ≥ 1 := by
  cases p with
  | nil _ _ => exact absurd rfl h
  | cons _ _ _ => exact Nat.succ_le_succ (Nat.zero_le _)
-- REFACTOR-BLOCK-REPLACEMENT-END: length_pos_of_ne

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: reverseDirected (was: refactor_reverseDirected)
/-- Reverse a directed walk.  Refactor port: case-split on the typed
step `s : refactor_WalkStep` instead of the original `Or`-disjunction
...
discharged via `hqv_dir.elim` (`refactor_IsDirectedWalk` returns
`False` there). -/
def refactor_Walk.refactor_reverseDirected {G : refactor_CDMG Node} :
    ∀ {c v : Node} (qv : refactor_Walk G c v),
      qv.refactor_IsDirectedWalk → refactor_Walk G v c
  | _, _, .nil w hw, _ => refactor_Walk.nil w hw
  | c, _, .cons _ (.forwardE h_E) qv', hqv_dir =>
      (refactor_Walk.refactor_reverseDirected qv' hqv_dir).refactor_comp
        (refactor_Walk.cons c (.backwardE h_E)
          (refactor_Walk.nil c
            (refactor_WalkStep.refactor_source_mem (.forwardE h_E))))
  | _, _, .cons _ (.backwardE _) _, hqv_dir => hqv_dir.elim
  | _, _, .cons _ (.bidir _) _, hqv_dir => hqv_dir.elim
-- REFACTOR-BLOCK-REPLACEMENT-END: reverseDirected

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: length_reverseDirected (was: refactor_length_reverseDirected)
lemma refactor_Walk.refactor_length_reverseDirected {G : refactor_CDMG Node} :
    ∀ {c v : Node} (qv : refactor_Walk G c v) (hqv_dir : qv.refactor_IsDirectedWalk),
      (refactor_Walk.refactor_reverseDirected qv hqv_dir).refactor_length = qv.refactor_length
  | _, _, .nil _ _, _ => rfl
  ...
  | _, _, .cons _ (.backwardE _) _, hqv_dir => hqv_dir.elim
  | _, _, .cons _ (.bidir _) _, hqv_dir => hqv_dir.elim
-- REFACTOR-BLOCK-REPLACEMENT-END: length_reverseDirected

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: vertices_reverseDirected (was: refactor_vertices_reverseDirected)
lemma refactor_Walk.refactor_vertices_reverseDirected {G : refactor_CDMG Node} :
    ∀ {c v : Node} (qv : refactor_Walk G c v) (hqv_dir : qv.refactor_IsDirectedWalk),
  ...
  | _, _, .cons _ (.backwardE _) _, hqv_dir => hqv_dir.elim
  | _, _, .cons _ (.bidir _) _, hqv_dir => hqv_dir.elim
-- REFACTOR-BLOCK-REPLACEMENT-END: vertices_reverseDirected

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: mkBifurcation (was: refactor_mkBifurcation)
/-- The bifurcation-walk constructor.  Refactor port: wrapper around
`refactor_reverseDirected` + `refactor_comp`. -/
def refactor_Walk.refactor_mkBifurcation {G : refactor_CDMG Node} {c v w : Node}
    (qv : refactor_Walk G c v) (hqv_dir : qv.refactor_IsDirectedWalk)
    (_hqv_pos : qv.refactor_length ≥ 1) (qw : refactor_Walk G c w) : refactor_Walk G v w :=
  (refactor_Walk.refactor_reverseDirected qv hqv_dir).refactor_comp qw
-- REFACTOR-BLOCK-REPLACEMENT-END: mkBifurcation

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: length_mkBifurcation (was: refactor_length_mkBifurcation)
lemma refactor_Walk.refactor_length_mkBifurcation {G : refactor_CDMG Node} {c v w : Node}
    (qv : refactor_Walk G c v) (hqv_dir : qv.refactor_IsDirectedWalk)
  ...
  rw [refactor_Walk.refactor_length_comp,
      refactor_Walk.refactor_length_reverseDirected qv hqv_dir]
-- REFACTOR-BLOCK-REPLACEMENT-END: length_mkBifurcation

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: vertices_mkBifurcation (was: refactor_vertices_mkBifurcation)
lemma refactor_Walk.refactor_vertices_mkBifurcation {G : refactor_CDMG Node} {c v w : Node}
    (qv : refactor_Walk G c v) (hqv_dir : qv.refactor_IsDirectedWalk)
    (hqv_pos : qv.refactor_length ≥ 1) (qw : refactor_Walk G c w) :
...
-- REFACTOR-BLOCK-REPLACEMENT-END: vertices_mkBifurcation

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: comp_assoc (was: refactor_comp_assoc)
lemma refactor_Walk.refactor_comp_assoc {G : refactor_CDMG Node} :
...
-- REFACTOR-BLOCK-REPLACEMENT-END: comp_assoc

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: isBifurcationDirectedHinge_cons_backward_of_directed (was: refactor_isBifurcationDirectedHinge_cons_backward_of_directed)
...
`refactor_IsBifurcationDirectedHingeWithSplit`, the
`.cons _ (.backwardE _) (cons _ _ _), 0` arm reduces directly to
`p.refactor_IsDirectedWalk`, so the goal collapses to `hp_dir`. -/
lemma refactor_Walk.refactor_isBifurcationDirectedHinge_cons_backward_of_directed
    {G : refactor_CDMG Node} {u v w : Node}
    (h : (v, u) ∈ G.E) (p : refactor_Walk G v w)
    (hp_dir : p.refactor_IsDirectedWalk)
    (hp_nonempty : p.refactor_length ≥ 1) :
    (refactor_Walk.cons v (.backwardE h) p).refactor_IsBifurcationDirectedHingeWithSplit 0 := by
  cases p with
  | nil _ _ => simp [refactor_Walk.refactor_length] at hp_nonempty
  | cons _ _ _ => exact hp_dir
-- REFACTOR-BLOCK-REPLACEMENT-END: isBifurcationDirectedHinge_cons_backward_of_directed

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: isBifurcationDirectedHinge_comp_reverseDirected_aux (was: refactor_isBifurcationDirectedHinge_comp_reverseDirected_aux)
...
lemma refactor_Walk.refactor_isBifurcationDirectedHinge_comp_reverseDirected_aux
...
-- REFACTOR-BLOCK-REPLACEMENT-END: isBifurcationDirectedHinge_comp_reverseDirected_aux

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: isBifurcationDirectedHinge_mkBifurcation (was: refactor_isBifurcationDirectedHinge_mkBifurcation)
...
`refactor_isBifurcationDirectedHinge_cons_backward_of_directed` drops
the `(a, ha_eq, ha_mem)` arguments. -/
lemma refactor_Walk.refactor_isBifurcationDirectedHinge_mkBifurcation
  ...
  change refactor_Walk.refactor_IsBifurcationDirectedHingeWithSplit
    ...
    (qv.refactor_length - 1)
  match qv, hqv_dir, hqv_pos with
  | .nil _ _, _, hpos => simp [refactor_Walk.refactor_length] at hpos
...
-- REFACTOR-BLOCK-REPLACEMENT-END: isBifurcationDirectedHinge_mkBifurcation
...
--      `refactor_Walk.cons vR (.bidir hLR) R` — significantly shorter.
-- Simplification (R3 in the workspace plan):
-- (a)  decl 40's nil-tail case in `h_base` collapses to `trivial`
--      under the new `refactor_IsBifurcationWithSplit`'s
...
--      `refactor_isBifurcationWithSplit_mkBifurcationBidir` call.

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: vertices_reverse_dropLast (was: refactor_vertices_reverse_dropLast)
/-- Vertex-list re-expression: `p.vertices.reverse.dropLast =
p.vertices.tail.reverse`.  Refactor port: pure list-level identity
modulo `vertices` → `refactor_vertices`. -/
lemma refactor_Walk.refactor_vertices_reverse_dropLast {G : refactor_CDMG Node}
    {u v : Node} (p : refactor_Walk G u v) :
    p.refactor_vertices.reverse.dropLast = p.refactor_vertices.tail.reverse := by
  conv_lhs => rw [refactor_Walk.refactor_vertices_eq_head_cons_tail p]
  rw [List.reverse_cons]
  exact List.dropLast_concat
-- REFACTOR-BLOCK-REPLACEMENT-END: vertices_reverse_dropLast

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: mkBifurcationBidir (was: refactor_mkBifurcationBidir)
...
def refactor_Walk.refactor_mkBifurcationBidir {G : refactor_CDMG Node}
    {vL vR v1 v2 : Node}
    (L : refactor_Walk G vL v1) (hL_dir : L.refactor_IsDirectedWalk)
    (R : refactor_Walk G vR v2)
    (hLR : s(vL, vR) ∈ G.L) : refactor_Walk G v1 v2 :=
  (refactor_Walk.refactor_reverseDirected L hL_dir).refactor_comp
    (refactor_Walk.cons vR (.bidir hLR) R)
-- REFACTOR-BLOCK-REPLACEMENT-END: mkBifurcationBidir

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: length_mkBifurcationBidir (was: refactor_length_mkBifurcationBidir)
lemma refactor_Walk.refactor_length_mkBifurcationBidir
    {G : refactor_CDMG Node} {vL vR v1 v2 : Node}
    (L : refactor_Walk G vL v1) (hL_dir : L.refactor_IsDirectedWalk)
    (R : refactor_Walk G vR v2) (hLR : s(vL, vR) ∈ G.L) :
    (refactor_Walk.refactor_mkBifurcationBidir L hL_dir R hLR).refactor_length
      = L.refactor_length + R.refactor_length + 1 := by
  change ((refactor_Walk.refactor_reverseDirected L hL_dir).refactor_comp _).refactor_length = _
  rw [refactor_Walk.refactor_length_comp,
      refactor_Walk.refactor_length_reverseDirected]
  change L.refactor_length + (R.refactor_length + 1) = L.refactor_length + R.refactor_length + 1
  omega
-- REFACTOR-BLOCK-REPLACEMENT-END: length_mkBifurcationBidir

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: vertices_mkBifurcationBidir (was: refactor_vertices_mkBifurcationBidir)
lemma refactor_Walk.refactor_vertices_mkBifurcationBidir
    {G : refactor_CDMG Node} {vL vR v1 v2 : Node}
    (L : refactor_Walk G vL v1) (hL_dir : L.refactor_IsDirectedWalk)
    (R : refactor_Walk G vR v2) (hLR : s(vL, vR) ∈ G.L) :
    (refactor_Walk.refactor_mkBifurcationBidir L hL_dir R hLR).refactor_vertices
      = L.refactor_vertices.reverse.dropLast ++ (vL :: R.refactor_vertices) := by
  change ((refactor_Walk.refactor_reverseDirected L hL_dir).refactor_comp _).refactor_vertices = _
  rw [refactor_Walk.refactor_vertices_comp,
      refactor_Walk.refactor_vertices_reverseDirected]
  rfl
-- REFACTOR-BLOCK-REPLACEMENT-END: vertices_mkBifurcationBidir

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: isBifurcationWithSplit_comp_reverseDirected_bidir_aux (was: refactor_isBifurcationWithSplit_comp_reverseDirected_bidir_aux)
...
arm of `refactor_IsBifurcationWithSplit` reduces directly to
`p.refactor_IsBifurcationWithSplit k`, so the inner `h_cons`
...
lemma refactor_Walk.refactor_isBifurcationWithSplit_comp_reverseDirected_bidir_aux
    {G : refactor_CDMG Node} :
    ∀ {c v : Node} (qv : refactor_Walk G c v) (hqv_dir : qv.refactor_IsDirectedWalk)
      {w : Node} (rest : refactor_Walk G c w) (k : ℕ)
      (_hrest : rest.refactor_IsBifurcationWithSplit k),
  ...
  | c, _, .cons _ (.forwardE h_E) qv', hqv_dir, _, rest, k, hrest => by
      have h_cons : refactor_Walk.refactor_IsBifurcationWithSplit
          (refactor_Walk.cons c (.backwardE h_E) rest) (k + 1) := by
        simp only [refactor_Walk.refactor_IsBifurcationWithSplit]
        exact hrest
      have ih := refactor_Walk.refactor_isBifurcationWithSplit_comp_reverseDirected_bidir_aux
        qv' hqv_dir (refactor_Walk.cons c (.backwardE h_E) rest) (k + 1) h_cons
      change refactor_Walk.refactor_IsBifurcationWithSplit
        (((refactor_Walk.refactor_reverseDirected qv' hqv_dir).refactor_comp
            (refactor_Walk.cons c (.backwardE h_E)
              (refactor_Walk.nil c
                (refactor_WalkStep.refactor_source_mem (.forwardE h_E))))).refactor_comp rest)
  ...
  | _, _, .cons _ (.backwardE _) _, hqv_dir, _, _, _, _ => hqv_dir.elim
  | _, _, .cons _ (.bidir _) _, hqv_dir, _, _, _, _ => hqv_dir.elim
-- REFACTOR-BLOCK-REPLACEMENT-END: isBifurcationWithSplit_comp_reverseDirected_bidir_aux

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: isBifurcationWithSplit_comp_right_directed (was: refactor_isBifurcationWithSplit_comp_right_directed)
/-- Right-extension: appending a directed walk `D` to the right of a
bifurcation walk `M` preserves the `refactor_IsBifurcationWithSplit`
...
Under the new `refactor_IsBifurcationWithSplit`, only `.backwardE _`
...
(now `True`), and `.cons` realises `p.refactor_IsDirectedWalk`
for both `.backwardE` and `.bidir`, so the right-arm extension is a
direct call to `refactor_isDirectedWalk_comp`. -/
lemma refactor_Walk.refactor_isBifurcationWithSplit_comp_right_directed
    {G : refactor_CDMG Node} :
    ∀ {u v : Node} (M : refactor_Walk G u v) (k : ℕ),
      M.refactor_IsBifurcationWithSplit k →
      ∀ {w : Node} (D : refactor_Walk G v w), D.refactor_IsDirectedWalk →
      (M.refactor_comp D).refactor_IsBifurcationWithSplit k := by
  intro u v M
  induction M with
  | nil _ _ => intro k hM _ _ _; exact hM.elim
  | @cons _u _v_end _vMid s M' ih =>
      ...
      | forwardE _ =>
          ...
          | succ _ =>
              simp only [refactor_Walk.refactor_IsBifurcationWithSplit] at hM
      | backwardE h_E =>
          cases k with
          | zero =>
              ...
              | nil _ _ => exact hM.elim
              | cons v' s' p =>
                  exact refactor_Walk.refactor_isDirectedWalk_comp
                    (refactor_Walk.cons v' s' p) D hM hD
          | succ k' =>
              -- `cons _ (.backwardE _) p, k+1` reduces to
              -- `p.refactor_IsBifurcationWithSplit k`; the goal reduces to
              -- `(p.refactor_comp D).refactor_IsBifurcationWithSplit k`.
              simp only [refactor_Walk.refactor_IsBifurcationWithSplit] at hM
              simp only [refactor_Walk.refactor_comp,
                         refactor_Walk.refactor_IsBifurcationWithSplit]
              exact ih k' hM D hD
      | bidir h_L =>
          cases k with
          | zero =>
              ...
              | nil _ _ =>
                  ...
                  -- Goal:
                  -- `(cons _ (.bidir _) D).refactor_IsBifurcationWithSplit 0`
                  -- — `True` if `D = nil`, `D.refactor_IsDirectedWalk` if cons.
                  cases D with
                  | nil _ _ => trivial
                  | cons _ _ _ => exact hD
              | cons v' s' p =>
          ...
          | succ _ =>
              simp only [refactor_Walk.refactor_IsBifurcationWithSplit] at hM
-- REFACTOR-BLOCK-REPLACEMENT-END: isBifurcationWithSplit_comp_right_directed

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: isBifurcationWithSplit_mkBifurcationBidir (was: refactor_isBifurcationWithSplit_mkBifurcationBidir)
/-- `refactor_mkBifurcationBidir L hL_dir R hLR` realises
`refactor_IsBifurcationWithSplit` at index `L.refactor_length`
...
to `p.refactor_IsDirectedWalk`, so `hR_dir` alone suffices. -/
lemma refactor_Walk.refactor_isBifurcationWithSplit_mkBifurcationBidir
    {G : refactor_CDMG Node} {vL vR v1 v2 : Node}
    (L : refactor_Walk G vL v1) (hL_dir : L.refactor_IsDirectedWalk)
    (R : refactor_Walk G vR v2) (hR_dir : R.refactor_IsDirectedWalk)
    (hLR : s(vL, vR) ∈ G.L) :
    (refactor_Walk.refactor_mkBifurcationBidir L hL_dir R hLR).refactor_IsBifurcationWithSplit
      L.refactor_length := by
  change refactor_Walk.refactor_IsBifurcationWithSplit
    ((refactor_Walk.refactor_reverseDirected L hL_dir).refactor_comp _) L.refactor_length
  -- The cons-cell with the bidirected hinge at i = 0.
  have h_base : refactor_Walk.refactor_IsBifurcationWithSplit
      (refactor_Walk.cons vR (.bidir hLR) R) 0 := by
    cases R with
    | nil _ _ =>
  ...
  have ih := refactor_Walk.refactor_isBifurcationWithSplit_comp_reverseDirected_bidir_aux
    L hL_dir _ 0 h_base
  have hidx : L.refactor_length + 0 = L.refactor_length := by omega
  rw [hidx] at ih
  exact ih
-- REFACTOR-BLOCK-REPLACEMENT-END: isBifurcationWithSplit_mkBifurcationBidir

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: mkBifurcationBidir_isBifurcation (was: refactor_mkBifurcationBidir_isBifurcation)
/-- Generic `refactor_IsBifurcation` lemma for `refactor_mkBifurcationBidir`.
...
`refactor_vertices` retarget and helper-name prefix substitutions.
...
already happens inside `refactor_isBifurcationWithSplit_mkBifurcationBidir`. -/
lemma refactor_Walk.refactor_mkBifurcationBidir_isBifurcation
    {G : refactor_CDMG Node} {vL vR v1 v2 : Node}
    (L : refactor_Walk G vL v1) (hL_dir : L.refactor_IsDirectedWalk)
    (R : refactor_Walk G vR v2) (hR_dir : R.refactor_IsDirectedWalk)
    (hLR : s(vL, vR) ∈ G.L)
    (hv1v2_ne : v1 ≠ v2)
    (hv1_notin_L_drop : v1 ∉ L.refactor_vertices.dropLast)
    (hv1_notin_R : v1 ∉ R.refactor_vertices)
    (hv2_notin_L : v2 ∉ L.refactor_vertices)
    (hv2_notin_R_drop : v2 ∉ R.refactor_vertices.dropLast) :
    (refactor_Walk.refactor_mkBifurcationBidir L hL_dir R hLR).refactor_IsBifurcation := by
  have h_mk_vs := refactor_Walk.refactor_vertices_mkBifurcationBidir L hL_dir R hLR
  -- Auxiliary: l.reverse.tail = l.dropLast.reverse for any list `l`.
  have h_aux : ∀ (l : List Node), l.reverse.tail = l.dropLast.reverse := by
    intro l
    induction l with
    ...
    | cons a rest ih =>
        ...
        · rw [List.reverse_cons, List.dropLast_cons_of_ne_nil h]
          ...
          · intro hr_empty
            exact h (List.reverse_eq_nil_iff.mp hr_empty)
  -- Auxiliary: L.refactor_vertices.reverse.dropLast = L.refactor_vertices.tail.reverse.
  have h_L_rev_drop : L.refactor_vertices.reverse.dropLast = L.refactor_vertices.tail.reverse :=
    refactor_Walk.refactor_vertices_reverse_dropLast L
  -- R.refactor_vertices is non-empty (always).
  have h_R_vs_ne : R.refactor_vertices ≠ [] := refactor_Walk.refactor_vertices_ne_nil R
  -- vL is in L.refactor_vertices (always — it's the source).
  have h_vL_in_L_vs : vL ∈ L.refactor_vertices := refactor_Walk.refactor_head_mem_vertices L
  refine ⟨hv1v2_ne, ?_, ?_, L.refactor_length, ?_⟩
  · -- v1 ∉ walk.refactor_vertices.tail.
    intro hv1_in_tail
    rw [h_mk_vs] at hv1_in_tail
    by_cases hL_drop_empty : L.refactor_vertices.reverse.dropLast = []
    · -- L is trivial: L = nil, vL = v1.
      rw [hL_drop_empty, List.nil_append] at hv1_in_tail
      change v1 ∈ R.refactor_vertices at hv1_in_tail
      exact hv1_notin_R hv1_in_tail
    · -- L has length ≥ 1.
      rw [List.tail_append_of_ne_nil hL_drop_empty] at hv1_in_tail
      rcases List.mem_append.mp hv1_in_tail with hv1_L_drop_tail | hv1_vL_R
      · rw [h_L_rev_drop] at hv1_L_drop_tail
        rw [h_aux] at hv1_L_drop_tail
        have hv1_t_drop : v1 ∈ L.refactor_vertices.tail.dropLast :=
          List.mem_reverse.mp hv1_L_drop_tail
        have h_L_tail_ne : L.refactor_vertices.tail ≠ [] := by
          intro h
          apply hL_drop_empty
          rw [h_L_rev_drop, h]; rfl
        have h_t_drop_eq : L.refactor_vertices.tail.dropLast
            = L.refactor_vertices.dropLast.tail := by
          rw [refactor_Walk.refactor_vertices_eq_head_cons_tail L]
          simp only [List.tail_cons]
          rw [List.dropLast_cons_of_ne_nil h_L_tail_ne]
          rfl
        rw [h_t_drop_eq] at hv1_t_drop
        exact hv1_notin_L_drop (List.mem_of_mem_tail hv1_t_drop)
      · rcases List.mem_cons.mp hv1_vL_R with h_v1_eq_vL | hv1_R
        · -- v1 = vL. Derive vL ∈ L.refactor_vertices.dropLast.
          have h_L_tail_ne : L.refactor_vertices.tail ≠ [] := by
            intro h
            apply hL_drop_empty
            rw [h_L_rev_drop, h]
            rfl
          have hvL_in_drop : vL ∈ L.refactor_vertices.dropLast := by
            rw [refactor_Walk.refactor_vertices_eq_head_cons_tail L]
            rw [List.dropLast_cons_of_ne_nil h_L_tail_ne]
            exact List.mem_cons_self
          exact hv1_notin_L_drop (h_v1_eq_vL ▸ hvL_in_drop)
        · exact hv1_notin_R hv1_R
  · -- v2 ∉ walk.refactor_vertices.dropLast.
    intro hv2_in_drop
    rw [h_mk_vs] at hv2_in_drop
    have h_vLR_ne : (vL :: R.refactor_vertices) ≠ [] := by simp
    rw [List.dropLast_append_of_ne_nil h_vLR_ne] at hv2_in_drop
    rcases List.mem_append.mp hv2_in_drop with hv2_L_rev | hv2_vLR
    · rw [h_L_rev_drop] at hv2_L_rev
      have hv2_tail : v2 ∈ L.refactor_vertices.tail := List.mem_reverse.mp hv2_L_rev
      exact hv2_notin_L (List.mem_of_mem_tail hv2_tail)
    · rw [List.dropLast_cons_of_ne_nil h_R_vs_ne] at hv2_vLR
      rcases List.mem_cons.mp hv2_vLR with rfl | hv2_R_drop
      · exact hv2_notin_L h_vL_in_L_vs
      · exact hv2_notin_R_drop hv2_R_drop
  · -- IsBifurcationWithSplit at L.refactor_length.
    exact refactor_Walk.refactor_isBifurcationWithSplit_mkBifurcationBidir
      L hL_dir R hR_dir hLR
-- REFACTOR-BLOCK-REPLACEMENT-END: mkBifurcationBidir_isBifurcation
...
--      `s : refactor_WalkStep`; we case-split on `s` *before* on
--      `i` / `p'` so each constructor's branch unfolds the
--      `refactor_IsBifurcation*` predicate cleanly;
...
--      because both `refactor_IsBifurcationDirectedHingeWithSplit`
--      and `refactor_IsBifurcationWithSplit` reduce to
--      `p.refactor_IsDirectedWalk` there (the original needed
...
--      `refactor_IsBifurcationWithSplit` on
--      `.cons _ (.bidir _) (.nil _ _), 0` is now `True` (the
--      original needed `⟨rfl, hLR⟩` for the
--      `a = (u, v) ∧ a ∈ G.L` disjunction-tag + L-membership).

set_option linter.style.longLine false in
-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: exists_arms_of_bifurcation_directed_hinge_strong (was: refactor_exists_arms_of_bifurcation_directed_hinge_strong)
...
in favour of `s : refactor_WalkStep G u vMid`, and we case-split on
...
`h_hinge = p'.refactor_IsBifurcation...k` is passed straight to
`ih k h_hinge`). -/
lemma refactor_Walk.refactor_exists_arms_of_bifurcation_directed_hinge_strong
    ...
    ∀ (i : ℕ), p.refactor_IsBifurcationDirectedHingeWithSplit i →
      ∃ (c : Node) (L : refactor_Walk G c v) (R : refactor_Walk G c w),
        ...
        (∀ x ∈ L.refactor_vertices.dropLast, x ∈ p.refactor_vertices.tail) ∧
        (∀ x ∈ R.refactor_vertices.dropLast, x ∈ p.refactor_vertices.dropLast) := by
  induction p with
  | nil v hv =>
      intro i h_hinge
      exact h_hinge.elim
  | @cons u w vMid s p' ih =>
      ...
      | backwardE h_E =>
          ...
          | zero =>
              ...
              | nil _ _ => exact h_hinge.elim
              | cons vMid' s' p'' =>
                  -- h_hinge : (cons vMid' s' p'').refactor_IsDirectedWalk
                  have hp'_dir :
                      (refactor_Walk.cons vMid' s' p'').refactor_IsDirectedWalk := h_hinge
                  have hu_in_G : u ∈ G :=
                    refactor_WalkStep.refactor_source_mem (G := G)
                      (refactor_WalkStep.backwardE (u := u) (v := vMid) h_E)
                  refine ⟨vMid,
                          refactor_Walk.cons u (.forwardE h_E) (refactor_Walk.nil u hu_in_G),
                          refactor_Walk.cons vMid' s' p'',
                          ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_⟩
                  · -- L.refactor_IsDirectedWalk: the single forward-E
                    -- step then nil unfolds to (nil _ _).refactor_IsDirectedWalk = True.
                    trivial
                  · exact hp'_dir
                  · change 0 + 1 ≥ 1; exact Nat.le_refl 1
                  ...
                  · intro x hx
                    ...
                    exact hx
                  · -- L.refactor_vertices.dropLast ⊆ p.refactor_vertices.tail
                    intro x hx
                    change x ∈ ([vMid, u] : List Node).dropLast at hx
                    change x ∈ vMid :: p''.refactor_vertices
                    simp [List.dropLast] at hx
                    subst hx
                    exact List.mem_cons_self
                  · -- R.refactor_vertices.dropLast ⊆ p.refactor_vertices.dropLast
                    intro x hx
                    have hp''_ne : p''.refactor_vertices ≠ [] :=
                      refactor_Walk.refactor_vertices_ne_nil _
                    change x ∈ (vMid :: p''.refactor_vertices).dropLast at hx
                    rw [List.dropLast_cons_of_ne_nil hp''_ne] at hx
                    have hp'_ne :
                        (refactor_Walk.cons vMid' s' p'').refactor_vertices ≠ [] :=
                      refactor_Walk.refactor_vertices_ne_nil _
          ...
          | succ k =>
              ...
              | cons vMid' s' p'' =>
                  -- h_hinge :
                  -- (cons vMid' s' p'').refactor_IsBifurcationDirectedHingeWithSplit k
                  have h_rec :
                      (refactor_Walk.cons vMid' s' p'').refactor_IsBifurcationDirectedHingeWithSplit k :=
                    h_hinge
                  obtain ⟨c, L', R, hL'_dir, hR_dir, _hL'_pos, hR_pos, h_idx_p',
                          hL'_sub, hR_sub, hL'_drop_sub, hR_drop_sub⟩ :=
                    ih k h_rec
                  ...
                  have hL_new_vs : (L'.refactor_comp single).refactor_vertices
                    ...
                    rw [refactor_Walk.refactor_vertices_comp]; rfl
                  have hp'_vs : (refactor_Walk.cons vMid' s' p'').refactor_vertices
                      = vMid :: p''.refactor_vertices := rfl
                  have hp'_ne :
                      (refactor_Walk.cons vMid' s' p'').refactor_vertices ≠ [] :=
                    refactor_Walk.refactor_vertices_ne_nil _
                  have hp''_ne : p''.refactor_vertices ≠ [] :=
                    refactor_Walk.refactor_vertices_ne_nil _
                  refine ⟨c, L'.refactor_comp single, R, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_⟩
                  · exact refactor_Walk.refactor_isDirectedWalk_comp L' single hL'_dir hsingle_dir
                  · exact hR_dir
                  · rw [refactor_Walk.refactor_length_comp]
                    change L'.refactor_length + 1 ≥ 1
                    exact Nat.succ_le_succ (Nat.zero_le _)
                  · exact hR_pos
                  · change (u :: (refactor_Walk.cons vMid' s' p'').refactor_vertices)[k + 1 + 1]?
                          = some c
                    simpa using h_idx_p'
                  · intro x hx
                    rw [hL_new_vs] at hx
                    ...
                    rw [List.dropLast_cons_of_ne_nil hp''_ne]
                    rcases List.mem_append.mp hx with hL'_drop | h_in_tail
                    · have hx_L'_vs : x ∈ L'.refactor_vertices :=
                        List.mem_of_mem_dropLast hL'_drop
                      have hx_p' : x ∈
                  ...
                  · intro x hx
                    have hx_p'_tail : x ∈
                        (refactor_Walk.cons vMid' s' p'').refactor_vertices.tail :=
                      hR_sub x hx
                    have hx_p' : x ∈ (refactor_Walk.cons vMid' s' p'').refactor_vertices :=
                      List.mem_of_mem_tail hx_p'_tail
                    change x ∈
                      (u :: (refactor_Walk.cons vMid' s' p'').refactor_vertices).tail
                    exact hx_p'
                  · -- L_new.refactor_vertices.dropLast ⊆ p.refactor_vertices.tail.
                    intro x hx
                    have hL_new_drop :
                        (L'.refactor_comp single).refactor_vertices.dropLast
                        = L'.refactor_vertices.dropLast ++ [vMid] := by
                      rw [hL_new_vs]
                      simp [List.dropLast]
                    rw [hL_new_drop] at hx
                    change x ∈
                      (u :: (refactor_Walk.cons vMid' s' p'').refactor_vertices).tail
                    change x ∈ (refactor_Walk.cons vMid' s' p'').refactor_vertices
                    rw [hp'_vs]
                    rcases List.mem_append.mp hx with hL'_drop | h_in_tail
                    · have hx_p'_tail : x ∈
                          (refactor_Walk.cons vMid' s' p'').refactor_vertices.tail :=
                  ...
                  · intro x hx
                    ...
                    rw [List.dropLast_cons_of_ne_nil hp''_ne]
                    exact List.mem_cons.mpr (Or.inr hx_p'_drop)
-- REFACTOR-BLOCK-REPLACEMENT-END: exists_arms_of_bifurcation_directed_hinge_strong

set_option linter.style.longLine false in
-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: mkBifurcation_isBifurcationSource (was: refactor_mkBifurcation_isBifurcationSource)
/-- Refactor port of decl 43.  Body is mechanical: every walk-level
helper retargets to its `refactor_*` twin (`refactor_vertices`,
`refactor_length`, `refactor_vertices_mkBifurcation`,
`refactor_isBifurcationDirectedHinge_mkBifurcation`, etc.).  The
inner `induction qv with | @cons _ _ _ _ _ p' ih => ...` updates to
`| @cons _ _ _ _ p' ih => ...` (one fewer wildcard, reflecting the
dropped `a : Node × Node` field of `refactor_Walk.cons`). -/
lemma refactor_Walk.refactor_mkBifurcation_isBifurcationSource
    {G : refactor_CDMG Node} {c v w : Node}
    (qv : refactor_Walk G c v) (hqv_dir : qv.refactor_IsDirectedWalk)
    (hqv_pos : qv.refactor_length ≥ 1)
    (qw : refactor_Walk G c w) (hqw_dir : qw.refactor_IsDirectedWalk)
    (hqw_pos : qw.refactor_length ≥ 1)
    (hvw_ne : v ≠ w)
    (hv_qv_drop : v ∉ qv.refactor_vertices.dropLast)
    (hv_qw : v ∉ qw.refactor_vertices)
    (hw_qv : w ∉ qv.refactor_vertices)
    (hw_qw_drop : w ∉ qw.refactor_vertices.dropLast) :
    (refactor_Walk.refactor_mkBifurcation qv hqv_dir hqv_pos qw).refactor_IsBifurcationSource c := by
  have h_mk_vs :
      (refactor_Walk.refactor_mkBifurcation qv hqv_dir hqv_pos qw).refactor_vertices
        = qv.refactor_vertices.reverse.dropLast ++ qw.refactor_vertices :=
  ...
  have h_qv_rev_drop_ne : qv.refactor_vertices.reverse.dropLast ≠ [] := by
    ...
    have : qv.refactor_vertices.tail = qv.refactor_vertices.tail.reverse.reverse := by
      rw [List.reverse_reverse]
    rw [this, hempty]; rfl
  have h_qw_vs_ne : qw.refactor_vertices ≠ [] := refactor_Walk.refactor_vertices_ne_nil qw
  have h_qw_drop_ne : qw.refactor_vertices.dropLast ≠ [] := by
    have h_qw_t_ne : qw.refactor_vertices.tail ≠ [] :=
      refactor_Walk.refactor_tail_vertices_ne_nil_of_pos qw hqw_pos
    intro hempty
    rw [refactor_Walk.refactor_vertices_eq_head_cons_tail qw] at hempty
    rw [List.dropLast_cons_of_ne_nil h_qw_t_ne] at hempty
    exact (List.cons_ne_nil _ _) hempty
  refine ⟨hvw_ne, ?_, ?_, ?_⟩
  · intro hv_in_tail
      ...
      have h_aux : ∀ (l : List Node), l.reverse.tail = l.dropLast.reverse := by
        ...
        | cons a rest ih =>
            ...
            · rw [List.reverse_cons, List.dropLast_cons_of_ne_nil h]
              ...
              · intro hr_empty
                exact h (List.reverse_eq_nil_iff.mp hr_empty)
      have h_t_rev_t : qv.refactor_vertices.tail.reverse.tail
          = qv.refactor_vertices.tail.dropLast.reverse :=
        h_aux qv.refactor_vertices.tail
      rw [h_t_rev_t] at hv_qv
      have hv_t_drop : v ∈ qv.refactor_vertices.tail.dropLast :=
        List.mem_reverse.mp hv_qv
      have h_t_drop_eq :
          qv.refactor_vertices.tail.dropLast = qv.refactor_vertices.dropLast.tail := by
        rw [refactor_Walk.refactor_vertices_eq_head_cons_tail qv]
        simp only [List.tail_cons]
        rw [List.dropLast_cons_of_ne_nil h_qv_tail_ne]
        rfl
      rw [h_t_drop_eq] at hv_t_drop
  ...
  · intro hw_in_drop
    ...
    rcases List.mem_append.mp hw_in_drop with hw_qv' | hw_qw_d
    · rw [h_qv_rev_drop] at hw_qv'
      have hw_t : w ∈ qv.refactor_vertices.tail := List.mem_reverse.mp hw_qv'
      exact hw_qv (List.mem_of_mem_tail hw_t)
    · exact hw_qw_drop hw_qw_d
  · refine ⟨qv.refactor_length - 1, ?_, ?_⟩
    · exact refactor_Walk.refactor_isBifurcationDirectedHinge_mkBifurcation
        qv hqv_dir hqv_pos qw hqw_dir hqw_pos
    · rw [h_mk_vs]
      have h_idx : qv.refactor_length - 1 + 1 = qv.refactor_length := by omega
      rw [h_idx]
      have h_rev_drop_len :
          qv.refactor_vertices.reverse.dropLast.length = qv.refactor_length := by
        rw [h_qv_rev_drop]
        rw [List.length_reverse]
        rw [refactor_Walk.refactor_vertices_eq_head_cons_tail qv]
        simp only [List.tail_cons]
        have h_len : qv.refactor_vertices.length = qv.refactor_length + 1 := by
          clear * -
          induction qv with
          | nil _ _ =>
              simp [refactor_Walk.refactor_vertices, refactor_Walk.refactor_length]
          | @cons _ _ _ _ p' ih =>
              simp [refactor_Walk.refactor_vertices, refactor_Walk.refactor_length]
              omega
        rw [refactor_Walk.refactor_vertices_eq_head_cons_tail qv] at h_len
        simp only [List.length_cons] at h_len
        omega
      rw [List.getElem?_append_right (by omega), h_rev_drop_len]
      simp
      rw [refactor_Walk.refactor_vertices_eq_head_cons_tail qw]
      simp
-- REFACTOR-BLOCK-REPLACEMENT-END: mkBifurcation_isBifurcationSource

set_option linter.style.longLine false in
-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: isBifurcationDirectedHingeWithSplit_to_isBifurcationWithSplit (was: refactor_isBifurcationDirectedHingeWithSplit_to_isBifurcationWithSplit)
/-- A directed-hinge bifurcation walk is also a (generic, sourceless)
bifurcation walk at the same split index.
...
`refactor_IsBifurcationDirectedHingeWithSplit` and
`refactor_IsBifurcationWithSplit` to the SAME body
`p.refactor_IsDirectedWalk`, so the implication is just `exact h`
...
lemma refactor_Walk.refactor_isBifurcationDirectedHingeWithSplit_to_isBifurcationWithSplit
    {G : refactor_CDMG Node} {u v : Node} :
    ∀ (p : refactor_Walk G u v) (i : ℕ),
      p.refactor_IsBifurcationDirectedHingeWithSplit i →
      p.refactor_IsBifurcationWithSplit i := by
  intro p
  induction p with
  | nil _ _ => intro i h; exact h
  | @cons _ _ _ s p' ih =>
...
-- REFACTOR-BLOCK-REPLACEMENT-END: isBifurcationDirectedHingeWithSplit_to_isBifurcationWithSplit

set_option linter.style.longLine false in
-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: isBifurcationSource_to_isBifurcation (was: refactor_isBifurcationSource_to_isBifurcation)
/-- `refactor_IsBifurcationSource` implies `refactor_IsBifurcation`:
just drop the source-tracking conjunct.  Refactor port: mechanical;
the inner forwarder is decl 44's `refactor_*` twin. -/
lemma refactor_Walk.refactor_isBifurcationSource_to_isBifurcation
    {G : refactor_CDMG Node} {u v : Node} (p : refactor_Walk G u v) (c : Node)
    (h : p.refactor_IsBifurcationSource c) : p.refactor_IsBifurcation := by
  obtain ⟨huv_ne, hu_tail, hv_drop, i, hh_dir, _⟩ := h
  refine ⟨huv_ne, hu_tail, hv_drop, i, ?_⟩
  exact refactor_Walk.refactor_isBifurcationDirectedHingeWithSplit_to_isBifurcationWithSplit
    p i hh_dir
-- REFACTOR-BLOCK-REPLACEMENT-END: isBifurcationSource_to_isBifurcation

set_option linter.style.longLine false in
-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: singleEdge_isBifurcation_of_bidir (was: refactor_singleEdge_isBifurcation_of_bidir)
/-- A single bidirected edge `s(u, v) ∈ G.L` gives a length-1 walk
`u → v` whose `refactor_IsBifurcation` predicate is satisfied (the
...
lemma refactor_Walk.refactor_singleEdge_isBifurcation_of_bidir
    {G : refactor_CDMG Node} {u v : Node} (_hu : u ∈ G) (hv : v ∈ G)
    (hLR : s(u, v) ∈ G.L) (huv : u ≠ v) :
    (refactor_Walk.cons v (.bidir hLR) (refactor_Walk.nil v hv)).refactor_IsBifurcation := by
  refine ⟨huv, ?_, ?_, 0, ?_⟩
  · intro h_in_tail
    change u ∈ [v] at h_in_tail
    rw [List.mem_singleton] at h_in_tail
  ...
  · intro h_in_drop
    ...
    simp [List.dropLast] at h_in_drop
    exact huv.symm h_in_drop
  · -- refactor_IsBifurcationWithSplit on `.cons _ (.bidir _) (.nil _ _), 0`
    -- reduces directly to `True`.
    trivial
-- REFACTOR-BLOCK-REPLACEMENT-END: singleEdge_isBifurcation_of_bidir

set_option linter.style.longLine false in
-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: exists_arms_of_bifurcation_bidir_hinge_strong (was: refactor_exists_arms_of_bifurcation_bidir_hinge_strong)
...
`p'.refactor_IsDirectedWalk`) against `h_not_dir` (which
reduces to `¬ p'.refactor_IsDirectedWalk`) via `absurd`; at
...
`refactor_IsBifurcationWithSplit` on `.cons _ (.bidir _) _, k + 1`
reduces to `False`. -/
lemma refactor_Walk.refactor_exists_arms_of_bifurcation_bidir_hinge_strong
    {G : refactor_CDMG Node} {v w : Node} (p : refactor_Walk G v w) :
    ∀ (i : ℕ), p.refactor_IsBifurcationWithSplit i →
      ¬ p.refactor_IsBifurcationDirectedHingeWithSplit i →
      ∃ (vL vR : Node) (L : refactor_Walk G vL v) (R : refactor_Walk G vR w),
        L.refactor_IsDirectedWalk ∧ R.refactor_IsDirectedWalk ∧
        s(vL, vR) ∈ G.L ∧
        p.refactor_vertices[i + 1]? = some vR ∧
        (∀ x ∈ L.refactor_vertices, x ∈ p.refactor_vertices.dropLast) ∧
        (∀ x ∈ R.refactor_vertices, x ∈ p.refactor_vertices.tail) ∧
        (∀ x ∈ L.refactor_vertices.dropLast, x ∈ p.refactor_vertices.tail) ∧
        (∀ x ∈ R.refactor_vertices.dropLast, x ∈ p.refactor_vertices.dropLast) := by
  ...
  | @cons u w vMid s p' ih =>
      ...
      | backwardE h_E =>
          ...
          | zero =>
              ...
              | nil _ _ => exact h_bif.elim
              | cons vMid' s' p'' =>
                  -- h_bif : (cons vMid' s' p'').refactor_IsDirectedWalk
                  -- h_not_dir : ¬ (cons vMid' s' p'').refactor_IsDirectedWalk
                  -- (IsBifurcationDirectedHingeWithSplit on .cons _ (.backwardE _)
                  --  (p@(.cons _ _ _)), 0 reduces to p.refactor_IsDirectedWalk —
          ...
          | succ k =>
              ...
              | cons vMid' s' p'' =>
                  -- h_bif :
                  -- (cons vMid' s' p'').refactor_IsBifurcationWithSplit k
                  -- h_not_dir :
                  -- ¬ (cons vMid' s' p'').refactor_IsBifurcationDirectedHingeWithSplit k
                  have h_rec :
                      (refactor_Walk.cons vMid' s' p'').refactor_IsBifurcationWithSplit k :=
                    h_bif
                  have h_rec_not_dir :
                      ¬ (refactor_Walk.cons vMid' s' p'').refactor_IsBifurcationDirectedHingeWithSplit k :=
                    h_not_dir
                  ...
                  have hp''_ne : p''.refactor_vertices ≠ [] :=
                    refactor_Walk.refactor_vertices_ne_nil _
                  refine ⟨vL, vR, L'.refactor_comp single, R, ?_, hR_dir, hLR_L,
                          ?_, ?_, ?_, ?_, ?_⟩
                  · exact refactor_Walk.refactor_isDirectedWalk_comp L' single hL'_dir hsingle_dir
                  · -- p.refactor_vertices[k+1+1]? = some vR.
                    change (u :: (refactor_Walk.cons vMid' s' p'').refactor_vertices)[k + 1 + 1]?
                          = some vR
                    simpa using h_idx_p'
                  · -- L_new.refactor_vertices ⊆ p.refactor_vertices.dropLast.
                    intro x hx
                    rw [hL_new_vs] at hx
                    change x ∈
                      (u :: (refactor_Walk.cons vMid' s' p'').refactor_vertices).dropLast
                    ...
                    · rcases List.mem_cons.mp h_in_tail with rfl | hx_in2
                      ...
                      · rcases List.mem_cons.mp hx_in2 with rfl | hx_empty
                        · exact List.mem_cons_self
                        · simp at hx_empty
                  · -- R.refactor_vertices ⊆ p.refactor_vertices.tail.
                    intro x hx
                    have hx_p'_tail : x ∈
                        (refactor_Walk.cons vMid' s' p'').refactor_vertices.tail :=
                      hR_sub x hx
                  ...
                  · -- L_new.refactor_vertices.dropLast ⊆ p.refactor_vertices.tail.
                    intro x hx
                    have hL_new_drop : (L'.refactor_comp single).refactor_vertices.dropLast
                        = L'.refactor_vertices.dropLast ++ [vMid] := by
                      rw [hL_new_vs]
                      simp [List.dropLast]
                    rw [hL_new_drop] at hx
      ...
      | bidir h_L =>
          ...
          | zero =>
              ...
              | nil _ hv_w =>
                  ...
                  -- `vMid` and `w` (since `p' : refactor_Walk G vMid w`); the
                  ...
                  -- h_bif : True (refactor_IsBifurcationWithSplit on
                  --  .cons _ (.bidir _) (.nil _ _), 0 reduces to True).
                  -- — R3/R5 simplification: no h_bif destructure needed.
                  -- hv_w : w ∈ G (from nil's witness — no hL_subset dance).
                  have hu_g : u ∈ G :=
                    refactor_WalkStep.refactor_source_mem (G := G)
                      (refactor_WalkStep.bidir (u := u) (v := w) h_L)
                  refine ⟨u, w, refactor_Walk.nil u hu_g,
                          refactor_Walk.nil w hv_w,
                          trivial, trivial, h_L, ?_, ?_, ?_, ?_, ?_⟩
                  · -- p.refactor_vertices[1]? = some w.
                    -- p.refactor_vertices = [u, w].
                    rfl
                  · -- L.refactor_vertices = [u] ⊆ p.refactor_vertices.dropLast = [u].
                    intro x hx
                    change x ∈ [u] at hx
                    rw [List.mem_singleton] at hx
                    rw [hx]
                    ...
                    simp [List.dropLast]
                  · -- R.refactor_vertices = [w] ⊆ p.refactor_vertices.tail = [w].
                    intro x hx
                    change x ∈ [w] at hx
                    rw [List.mem_singleton] at hx
                    rw [hx]
                    ...
                    simp [List.tail]
                  · -- L.refactor_vertices.dropLast = [u].dropLast = [], vacuously ⊆.
                    intro x hx
                    change x ∈ ([u] : List Node).dropLast at hx
                    simp [List.dropLast] at hx
                  · -- R.refactor_vertices.dropLast = [w].dropLast = [], vacuously ⊆.
                    intro x hx
              ...
              | cons vMid' s' p'' =>
                  ...
                  have hp'_dir :
                      (refactor_Walk.cons vMid' s' p'').refactor_IsDirectedWalk := h_bif
                  have hu_g : u ∈ G :=
                    refactor_WalkStep.refactor_source_mem (G := G)
                      (refactor_WalkStep.bidir (u := u) (v := vMid) h_L)
                  refine ⟨u, vMid, refactor_Walk.nil u hu_g,
                          refactor_Walk.cons vMid' s' p'',
                          trivial, hp'_dir, h_L, ?_, ?_, ?_, ?_, ?_⟩
                  · -- p.refactor_vertices[1]? = some vMid.
                    rfl
                  · -- L.refactor_vertices = [u] ⊆ p.refactor_vertices.dropLast.
                    intro x hx
                    change x ∈ [u] at hx
                    rw [List.mem_singleton] at hx
                    rw [hx]
          ...
          | succ _ =>
              ...
              | nil _ _ => exact h_bif.elim
              | cons _ _ _ => exact h_bif.elim
-- REFACTOR-BLOCK-REPLACEMENT-END: exists_arms_of_bifurcation_bidir_hinge_strong

-- ## Refactor replacements — Batch 9 (declarations 48–55)
--
-- Two source-tracking forward / backward helpers for sub-claim ii(b)
-- (`refactor_marg_preserves_bifSource_forward` /
-- `refactor_marg_preserves_bifSource_backward`), two mechanical
-- wrappers `refactor_marg_bif_forward_dir_hinge_src_marg` /
-- `refactor_marg_bif_backward_dir_hinge` reducing sub-claim ii(a)
-- (directed-hinge case) to ii(b), and four list-/walk-bookkeeping
-- helpers (`refactor_Walk.refactor_vertices_getLast`,
-- `refactor_Walk.refactor_tail_getLast_of_pos`,
-- `refactor_Walk.refactor_length_pos_of_isBifurcation`,
-- `refactor_Walk.refactor_arm_dropLast_in_W`) used uniformly by the
-- backward-direction bidirected-hinge case (Batch 10) to discharge
-- the vertex-bound clauses on the extracted arms.
--
-- All eight are mechanical ports against the typed-`refactor_WalkStep`
-- + `refactor_Walk.cons _ s p` 3-arg cons cell.  The cons-skip pattern
...
(`refactor_Walk.refactor_exists_arms_of_bifurcation_directed_hinge_strong`,
...
`refactor_Walk.refactor_length_pos_of_ne`,
`refactor_Walk.refactor_mkBifurcation`,
`refactor_Walk.refactor_mkBifurcation_isBifurcationSource`);
`G.marginalize` → `G.refactor_marginalize`;
`.vertices` → `.refactor_vertices`.  No structural changes. -/
lemma refactor_marg_preserves_bifSource_forward (G : refactor_CDMG Node)
    (W : Finset Node) (hW : W ⊆ G.V) {u w v₃ : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    (hv₃ : v₃ ∈ G.refactor_marginalize W hW)
    (h : ∃ p : refactor_Walk G u w, p.refactor_IsBifurcationSource v₃) :
    ∃ q : refactor_Walk (G.refactor_marginalize W hW) u w,
      q.refactor_IsBifurcationSource v₃ := by
  obtain ⟨p, hp_src⟩ := h
  obtain ⟨huw_ne, hu_tail, hw_drop, i, hhinge, hsrc⟩ := hp_src
  obtain ⟨c, L, R, hL_dir, hR_dir, hL_pos, hR_pos, hidx,
          hL_sub, hR_sub, hL_drop_sub, hR_drop_sub⟩ :=
    refactor_Walk.refactor_exists_arms_of_bifurcation_directed_hinge_strong p i hhinge
  have hc_eq_v3 : c = v₃ := by
    rw [hidx] at hsrc
    exact Option.some.inj hsrc
  -- v₃ ≠ u via L.refactor_vertices.dropLast ⊆ p.refactor_vertices.tail + hu_tail.
  have hv3_ne_u : v₃ ≠ u := by
    intro heq
    have h_c_drop : c ∈ L.refactor_vertices.dropLast := by
      have hL_vs : L.refactor_vertices = c :: L.refactor_vertices.tail :=
        refactor_Walk.refactor_vertices_eq_head_cons_tail L
      have h_t_ne : L.refactor_vertices.tail ≠ [] :=
        refactor_Walk.refactor_tail_vertices_ne_nil_of_pos L hL_pos
      rw [hL_vs]
      rw [List.dropLast_cons_of_ne_nil h_t_ne]
      exact List.mem_cons_self
    have h_c_p_tail : c ∈ p.refactor_vertices.tail := hL_drop_sub c h_c_drop
    have hc_eq_u : c = u := hc_eq_v3.trans heq
    exact hu_tail (hc_eq_u ▸ h_c_p_tail)
  have hv3_ne_w : v₃ ≠ w := by
    intro heq
    have h_c_drop : c ∈ R.refactor_vertices.dropLast := by
      have hR_vs : R.refactor_vertices = c :: R.refactor_vertices.tail :=
        refactor_Walk.refactor_vertices_eq_head_cons_tail R
      have h_t_ne : R.refactor_vertices.tail ≠ [] :=
        refactor_Walk.refactor_tail_vertices_ne_nil_of_pos R hR_pos
      rw [hR_vs]
      rw [List.dropLast_cons_of_ne_nil h_t_ne]
      exact List.mem_cons_self
    have h_c_p_drop : c ∈ p.refactor_vertices.dropLast := hR_drop_sub c h_c_drop
    have hc_eq_w : c = w := hc_eq_v3.trans heq
    exact hw_drop (hc_eq_w ▸ h_c_p_drop)
  ...
  have hL'_pos : L'.refactor_length ≥ 1 :=
    refactor_Walk.refactor_length_pos_of_ne L' (hc_eq_v3 ▸ hv3_ne_u)
  have hR'_pos : R'.refactor_length ≥ 1 :=
    refactor_Walk.refactor_length_pos_of_ne R' (hc_eq_v3 ▸ hv3_ne_w)
  -- Verify the four vertex-bound conditions for the generic mkBif lemma.
  have hu_notin_L'_drop : u ∉ L'.refactor_vertices.dropLast := fun h_u =>
    hu_tail (hL_drop_sub u (hL'_drop u h_u))
  have hu_notin_R' : u ∉ R'.refactor_vertices := fun h_u =>
    hu_tail (hR_sub u (hR'_sub u h_u))
  have hw_notin_L' : w ∉ L'.refactor_vertices := fun h_w =>
    hw_drop (hL_sub w (hL'_sub w h_w))
  have hw_notin_R'_drop : w ∉ R'.refactor_vertices.dropLast := fun h_w =>
    hw_drop (hR_drop_sub w (hR'_drop w h_w))
  refine ⟨refactor_Walk.refactor_mkBifurcation L' hL'_dir hL'_pos R', ?_⟩
  have h_bif_src :=
    refactor_Walk.refactor_mkBifurcation_isBifurcationSource
...
`refactor_expand_directed_walk_marginalize`, then assemble via
`refactor_Walk.refactor_mkBifurcation`.  Mechanical port — same
retarget pattern as (48), plus
`expand_directed_walk_marginalize` → `refactor_expand_directed_walk_marginalize`
and `notW_of_mem_marginalize` → `refactor_notW_of_mem_marginalize`. -/
lemma refactor_marg_preserves_bifSource_backward (G : refactor_CDMG Node)
    (W : Finset Node) (hW : W ⊆ G.V) {u w v₃ : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    (hv₃ : v₃ ∈ G.refactor_marginalize W hW)
    (h : ∃ q : refactor_Walk (G.refactor_marginalize W hW) u w,
            q.refactor_IsBifurcationSource v₃) :
    ∃ p : refactor_Walk G u w, p.refactor_IsBifurcationSource v₃ := by
  obtain ⟨q, hq_src⟩ := h
  obtain ⟨huw_ne, hu_tail, hw_drop, i, hhinge, hsrc⟩ := hq_src
  obtain ⟨c, Lq, Rq, hLq_dir, hRq_dir, hLq_pos, hRq_pos, hidx,
          hLq_sub, hRq_sub, hLq_drop_sub, hRq_drop_sub⟩ :=
    refactor_Walk.refactor_exists_arms_of_bifurcation_directed_hinge_strong q i hhinge
  have hc_eq_v3 : c = v₃ := by
    rw [hidx] at hsrc
    exact Option.some.inj hsrc
  -- v₃ ≠ u, v₃ ≠ w (analogous to forward direction).
  have hv3_ne_u : v₃ ≠ u := by
    intro heq
    have h_c_drop : c ∈ Lq.refactor_vertices.dropLast := by
      have hLq_vs : Lq.refactor_vertices = c :: Lq.refactor_vertices.tail :=
        refactor_Walk.refactor_vertices_eq_head_cons_tail Lq
      have h_t_ne : Lq.refactor_vertices.tail ≠ [] :=
        refactor_Walk.refactor_tail_vertices_ne_nil_of_pos Lq hLq_pos
      rw [hLq_vs]
      rw [List.dropLast_cons_of_ne_nil h_t_ne]
      exact List.mem_cons_self
    have h_c_q_tail : c ∈ q.refactor_vertices.tail := hLq_drop_sub c h_c_drop
    have hc_eq_u : c = u := hc_eq_v3.trans heq
    exact hu_tail (hc_eq_u ▸ h_c_q_tail)
  have hv3_ne_w : v₃ ≠ w := by
    intro heq
    have h_c_drop : c ∈ Rq.refactor_vertices.dropLast := by
      have hRq_vs : Rq.refactor_vertices = c :: Rq.refactor_vertices.tail :=
        refactor_Walk.refactor_vertices_eq_head_cons_tail Rq
      have h_t_ne : Rq.refactor_vertices.tail ≠ [] :=
        refactor_Walk.refactor_tail_vertices_ne_nil_of_pos Rq hRq_pos
      rw [hRq_vs]
      rw [List.dropLast_cons_of_ne_nil h_t_ne]
      exact List.mem_cons_self
    have h_c_q_drop : c ∈ q.refactor_vertices.dropLast := hRq_drop_sub c h_c_drop
    have hc_eq_w : c = w := hc_eq_v3.trans heq
    exact hw_drop (hc_eq_w ▸ h_c_q_drop)
  -- Expand Lq and Rq to walks in G.
  obtain ⟨L, hL_dir, hL_len, hL_sub_W, hL_drop_sub_W, _, _⟩ :=
  ...
  have hL_pos : L.refactor_length ≥ 1 := by omega
  have hR_pos : R.refactor_length ≥ 1 := by omega
  -- Auxiliary: c ∉ W (since c = v₃ ∈ marg).
  have hc_notW : c ∉ W := by
    rw [hc_eq_v3]
  ...
  -- Verify the four conditions.
  have hu_notin_L_drop : u ∉ L.refactor_vertices.dropLast := by
    intro h_u
    rcases hL_drop_sub_W u h_u with h_Lq_drop | h_u_W
    · exact hu_tail (hLq_drop_sub u h_Lq_drop)
    · exact hu_notW h_u_W
  have hu_notin_R : u ∉ R.refactor_vertices := by
    intro h_u
    rcases hR_sub_W u h_u with h_Rq | h_u_W
    · exact hu_tail (hRq_sub u h_Rq)
    · exact hu_notW h_u_W
  have hw_notin_L : w ∉ L.refactor_vertices := by
    intro h_w
    rcases hL_sub_W w h_w with h_Lq | h_w_W
    · exact hw_drop (hLq_sub w h_Lq)
    · exact hw_notW h_w_W
  have hw_notin_R_drop : w ∉ R.refactor_vertices.dropLast := by
    intro h_w
    rcases hR_drop_sub_W w h_w with h_Rq_drop | h_w_W
    · exact hw_drop (hRq_drop_sub w h_Rq_drop)
    · exact hw_notW h_w_W
  refine ⟨refactor_Walk.refactor_mkBifurcation L hL_dir hL_pos R, ?_⟩
  have h_bif_src :=
    refactor_Walk.refactor_mkBifurcation_isBifurcationSource
...
witness, dispatch to (48)'s `refactor_marg_preserves_bifSource_forward`,
then convert back via
`refactor_Walk.refactor_isBifurcationSource_to_isBifurcation`. -/
lemma refactor_marg_bif_forward_dir_hinge_src_marg
    (G : refactor_CDMG Node) (W : Finset Node) (hW : W ⊆ G.V) {u w : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    {p : refactor_Walk G u w} (hp : p.refactor_IsBifurcation)
    {i : ℕ} (h_dir : p.refactor_IsBifurcationDirectedHingeWithSplit i)
    {c : Node} (hidx : p.refactor_vertices[i + 1]? = some c)
    (hc_marg : c ∈ G.refactor_marginalize W hW) :
    ∃ q : refactor_Walk (G.refactor_marginalize W hW) u w, q.refactor_IsBifurcation := by
  obtain ⟨huw_ne, hu_tail, hw_drop, _, _⟩ := hp
  have hp_src : p.refactor_IsBifurcationSource c :=
    ⟨huw_ne, hu_tail, hw_drop, i, h_dir, hidx⟩
  obtain ⟨q, hq_src⟩ :=
    refactor_marg_preserves_bifSource_forward G W hW hu hw hc_marg ⟨p, hp_src⟩
  exact ⟨q, refactor_Walk.refactor_isBifurcationSource_to_isBifurcation q c hq_src⟩
...
via `refactor_Walk.refactor_mem_of_mem_vertices`), dispatch to (49)'s
`refactor_marg_preserves_bifSource_backward`, then convert back via
`refactor_Walk.refactor_isBifurcationSource_to_isBifurcation`. -/
lemma refactor_marg_bif_backward_dir_hinge
    (G : refactor_CDMG Node) (W : Finset Node) (hW : W ⊆ G.V) {u w : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    {q : refactor_Walk (G.refactor_marginalize W hW) u w} (hq : q.refactor_IsBifurcation)
    {i : ℕ} (h_dir : q.refactor_IsBifurcationDirectedHingeWithSplit i) :
    ∃ p : refactor_Walk G u w, p.refactor_IsBifurcation := by
  obtain ⟨huw_ne, hu_tail, hw_drop, _, _⟩ := hq
  obtain ⟨c, _, _, _, _, _, _, hidx, _, _, _, _⟩ :=
    refactor_Walk.refactor_exists_arms_of_bifurcation_directed_hinge_strong q i h_dir
  have hc_in_q : c ∈ q.refactor_vertices := List.mem_of_getElem? hidx
  have hc_marg : c ∈ G.refactor_marginalize W hW :=
    refactor_Walk.refactor_mem_of_mem_vertices q hc_in_q
  have hq_src : q.refactor_IsBifurcationSource c :=
    ⟨huw_ne, hu_tail, hw_drop, i, h_dir, hidx⟩
  obtain ⟨p, hp_src⟩ :=
    refactor_marg_preserves_bifSource_backward G W hW hu hw hc_marg ⟨q, hq_src⟩
  exact ⟨p, refactor_Walk.refactor_isBifurcationSource_to_isBifurcation p c hp_src⟩
-- REFACTOR-BLOCK-REPLACEMENT-END: marg_bif_backward_dir_hinge

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: vertices_getLast (was: refactor_vertices_getLast)
/-- The last vertex of any walk equals its target.  Refactor port:
cons-skip pattern shifts from `.cons _ _ _ p'` (4 args) to
`.cons _ _ p'` (3 args). -/
lemma refactor_Walk.refactor_vertices_getLast {G : refactor_CDMG Node} :
    ∀ {u v : Node} (p : refactor_Walk G u v),
      p.refactor_vertices.getLast (refactor_Walk.refactor_vertices_ne_nil p) = v
  | _, _, .nil _ _ => rfl
  | _, _, .cons _ _ p' => by
      simp only [refactor_Walk.refactor_vertices]
      rw [List.getLast_cons (refactor_Walk.refactor_vertices_ne_nil p')]
      exact refactor_Walk.refactor_vertices_getLast p'
-- REFACTOR-BLOCK-REPLACEMENT-END: vertices_getLast

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: tail_getLast_of_pos (was: refactor_tail_getLast_of_pos)
/-- For a walk with `refactor_length ≥ 1`, its vertex list's tail
...
lemma refactor_Walk.refactor_tail_getLast_of_pos {G : refactor_CDMG Node} {u v : Node}
    (p : refactor_Walk G u v) (hp_pos : p.refactor_length ≥ 1) :
    p.refactor_vertices.tail.getLast
        (refactor_Walk.refactor_tail_vertices_ne_nil_of_pos p hp_pos) = v := by
  cases p with
  | nil _ _ => simp [refactor_Walk.refactor_length] at hp_pos
  | @cons u' v' vMid s p' =>
      show p'.refactor_vertices.getLast _ = v
      exact refactor_Walk.refactor_vertices_getLast p'
-- REFACTOR-BLOCK-REPLACEMENT-END: tail_getLast_of_pos

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: length_pos_of_isBifurcation (was: refactor_length_pos_of_isBifurcation)
/-- `M.refactor_IsBifurcation → M.refactor_length ≥ 1`.  Refactor port:
cons-skip pattern shifts from `.cons _ _ _ _` (4 wildcards) to
`.cons _ _ _` (3 wildcards). -/
lemma refactor_Walk.refactor_length_pos_of_isBifurcation
    {G : refactor_CDMG Node} {u v : Node}
    {M : refactor_Walk G u v} (hM : M.refactor_IsBifurcation) :
    M.refactor_length ≥ 1 := by
  obtain ⟨_, _, _, _, h_split⟩ := hM
  cases M with
  | nil _ _ => exact h_split.elim
  | cons _ _ _ => exact Nat.succ_le_succ (Nat.zero_le _)
-- REFACTOR-BLOCK-REPLACEMENT-END: length_pos_of_isBifurcation

-- REFACTOR-BLOCK-REPLACEMENT-BEGIN: arm_dropLast_in_W (was: refactor_arm_dropLast_in_W)
/-- Helper for the backward bidirected case:
`arm.refactor_vertices.dropLast ⊆ W`, given direct bounds on
`arm.refactor_vertices.dropLast` into both `M.refactor_vertices.tail`
and `M.refactor_vertices.dropLast`.  Refactor port: mechanical retarget
of every walk-level helper to its `refactor_*` twin. -/
lemma refactor_Walk.refactor_arm_dropLast_in_W {G : refactor_CDMG Node} {a b : Node}
    {M : refactor_Walk G a b} (hM_bif : M.refactor_IsBifurcation)
    {W : Finset Node}
    (hM_W : ∀ x ∈ M.refactor_vertices.tail.dropLast, x ∈ W)
    {c d : Node} {arm : refactor_Walk G c d}
    (h_arm_drop_in_tail :
        ∀ x ∈ arm.refactor_vertices.dropLast, x ∈ M.refactor_vertices.tail)
    (h_arm_drop_in_drop :
        ∀ x ∈ arm.refactor_vertices.dropLast, x ∈ M.refactor_vertices.dropLast) :
    ∀ x ∈ arm.refactor_vertices.dropLast, x ∈ W := by
  intro x hx
  have hM_pos : M.refactor_length ≥ 1 :=
    refactor_Walk.refactor_length_pos_of_isBifurcation hM_bif
  have h_M_tail_ne : M.refactor_vertices.tail ≠ [] :=
    refactor_Walk.refactor_tail_vertices_ne_nil_of_pos M hM_pos
  have h_M_tail_last : M.refactor_vertices.tail.getLast h_M_tail_ne = b :=
    refactor_Walk.refactor_tail_getLast_of_pos M hM_pos
  have h_M_tail_decomp :
      M.refactor_vertices.tail = M.refactor_vertices.tail.dropLast ++ [b] := by
    have := List.dropLast_append_getLast h_M_tail_ne
    rw [h_M_tail_last] at this
    exact this.symm
  have h_M_vs_eq : M.refactor_vertices = a :: M.refactor_vertices.tail :=
    refactor_Walk.refactor_vertices_eq_head_cons_tail M
  have h_M_drop_decomp :
      M.refactor_vertices.dropLast = a :: M.refactor_vertices.tail.dropLast := by
    conv_lhs => rw [h_M_vs_eq]
    rw [List.dropLast_cons_of_ne_nil h_M_tail_ne]
  have hx_M_tail : x ∈ M.refactor_vertices.tail := h_arm_drop_in_tail x hx
  have hx_M_drop : x ∈ M.refactor_vertices.dropLast := h_arm_drop_in_drop x hx
  rw [h_M_tail_decomp] at hx_M_tail
  rcases List.mem_append.mp hx_M_tail with h_in_interior | h_eq_b
  · exact hM_W x h_in_interior
  · rw [List.mem_singleton] at h_eq_b
    ...
    · have : a = b := h_eq_a.symm.trans h_eq_b
      exact absurd this hM_bif.1
    · exact hM_W x h_in_interior
-- REFACTOR-BLOCK-REPLACEMENT-END: arm_dropLast_in_W
...
`refactor_marginalize_L_iff` (Sym2-image unwrap, two-case Sym2.eq
dance for the orientation), and the bidirected hinge from
`refactor_exists_arms_of_bifurcation_bidir_hinge_strong` arrives as
...
expected by `refactor_mkBifurcationBidir`.  No logic change. -/
lemma refactor_marg_bif_backward_bidir_hinge
    (G : refactor_CDMG Node) (W : Finset Node) (hW : W ⊆ G.V) {u w : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    {q : refactor_Walk (G.refactor_marginalize W hW) u w} (hq : q.refactor_IsBifurcation)
    {i : ℕ} (h_split : q.refactor_IsBifurcationWithSplit i)
    (h_not_dir : ¬ q.refactor_IsBifurcationDirectedHingeWithSplit i) :
    ∃ p : refactor_Walk G u w, p.refactor_IsBifurcation := by
  obtain ⟨huw_ne, hu_tail, hw_drop, _, _⟩ := hq
  obtain ⟨vL, vR, L_marg, R_marg, hL_marg_dir, hR_marg_dir, hLR_marg, hidx,
          hL_marg_sub, hR_marg_sub, hL_marg_drop_sub, hR_marg_drop_sub⟩ :=
  ...
  obtain ⟨e, he1_VW, he2_VW, _he_ne, h_phi_L_e, hs_eq⟩ :=
    (refactor_marginalize_L_iff G W hW).mp hLR_marg
  ...
  have h_pack : vL ∈ G.V \ W ∧ vR ∈ G.V \ W ∧
                G.refactor_MarginalizationΦL W vL vR := by
  ...
  have hu_notW : u ∉ W := refactor_notW_of_mem_marginalize hW hu
  have hw_notW : w ∉ W := refactor_notW_of_mem_marginalize hW hw
  -- Show vR ∈ q.refactor_vertices.tail (vR is at position i+1).
  have hvR_in_q_tail : vR ∈ q.refactor_vertices.tail := by
    have h_vs_eq : q.refactor_vertices = u :: q.refactor_vertices.tail :=
      refactor_Walk.refactor_vertices_eq_head_cons_tail q
    rw [h_vs_eq] at hidx
    have h_tail_idx : q.refactor_vertices.tail[i]? = some vR := by simpa using hidx
    exact List.mem_of_getElem? h_tail_idx
  have hu_ne_vR : u ≠ vR := fun heq => hu_tail (heq ▸ hvR_in_q_tail)
  -- Show w ≠ vL (since vL is at position i in q.refactor_vertices.dropLast).
  have hvL_in_q_drop : vL ∈ q.refactor_vertices.dropLast :=
    hL_marg_sub vL (refactor_Walk.refactor_head_mem_vertices L_marg)
  have hw_ne_vL : w ≠ vL := fun heq => hw_drop (heq ▸ hvL_in_q_drop)
  -- Expand L_marg, R_marg to G-walks.
  obtain ⟨L_g, hL_g_dir, _hL_g_len, hL_g_sub_W, hL_g_drop_sub_W, _, _⟩ :=
  ...
  have hu_notin_L_g_drop : u ∉ L_g.refactor_vertices.dropLast := fun h_in =>
    (hL_g_drop_sub_W u h_in).elim
      (fun h_marg => hu_tail (hL_marg_drop_sub u h_marg)) hu_notW
  have hu_notin_R_g : u ∉ R_g.refactor_vertices := fun h_in =>
    (hR_g_sub_W u h_in).elim
      (fun h_marg => hu_tail (hR_marg_sub u h_marg)) hu_notW
  have hw_notin_L_g : w ∉ L_g.refactor_vertices := fun h_in =>
    (hL_g_sub_W w h_in).elim
      (fun h_marg => hw_drop (hL_marg_sub w h_marg)) hw_notW
  have hw_notin_R_g_drop : w ∉ R_g.refactor_vertices.dropLast := fun h_in =>
    (hR_g_drop_sub_W w h_in).elim
      (fun h_marg => hw_drop (hR_marg_drop_sub w h_marg)) hw_notW
  -- Case-split on Φ_L orientation.
  rcases h_phi_L with ⟨M, hM_bif, hM_W⟩ | ⟨M, hM_bif, hM_W⟩
  · -- inl case: M : refactor_Walk G vL vR.
    have hM_split_ex : ∃ i, M.refactor_IsBifurcationWithSplit i := hM_bif.2.2.2
    obtain ⟨k_M, hM_split⟩ := hM_split_ex
    ...
    · -- Inl + directed M-hinge.
      obtain ⟨c_M, M_L, M_R, hM_L_dir, hM_R_dir, hM_L_pos, hM_R_pos, _,
        ...
        refactor_Walk.refactor_exists_arms_of_bifurcation_directed_hinge_strong
          M k_M h_M_dir
      -- qv (c_M → u) = M_L.refactor_comp L_g, qw (c_M → w) = M_R.refactor_comp R_g.
      have hqv_dir : (M_L.refactor_comp L_g).refactor_IsDirectedWalk :=
        refactor_Walk.refactor_isDirectedWalk_comp M_L L_g hM_L_dir hL_g_dir
      have hqw_dir : (M_R.refactor_comp R_g).refactor_IsDirectedWalk :=
        refactor_Walk.refactor_isDirectedWalk_comp M_R R_g hM_R_dir hR_g_dir
      have hqv_len : (M_L.refactor_comp L_g).refactor_length
                       = M_L.refactor_length + L_g.refactor_length :=
        refactor_Walk.refactor_length_comp M_L L_g
      have hqw_len : (M_R.refactor_comp R_g).refactor_length
                       = M_R.refactor_length + R_g.refactor_length :=
        refactor_Walk.refactor_length_comp M_R R_g
      have hqv_pos : (M_L.refactor_comp L_g).refactor_length ≥ 1 := by
        rw [hqv_len]; omega
      have hqw_pos : (M_R.refactor_comp R_g).refactor_length ≥ 1 := by
        rw [hqw_len]; omega
      -- Vertex-bound checks via refactor_arm_dropLast_in_W + expansions.
      have hu_notin_M_L_drop : u ∉ M_L.refactor_vertices.dropLast := fun h_in =>
        hu_notW (refactor_Walk.refactor_arm_dropLast_in_W hM_bif hM_W hM_L_drop_sub
            (fun x hx => hM_L_sub x (List.mem_of_mem_dropLast hx)) u h_in)
      have hu_notin_M_R_drop : u ∉ M_R.refactor_vertices.dropLast := fun h_in =>
        hu_notW (refactor_Walk.refactor_arm_dropLast_in_W hM_bif hM_W
            (fun x hx => hM_R_sub x (List.mem_of_mem_dropLast hx)) hM_R_drop_sub u h_in)
      have hw_notin_M_L_drop : w ∉ M_L.refactor_vertices.dropLast := fun h_in =>
        hw_notW (refactor_Walk.refactor_arm_dropLast_in_W hM_bif hM_W hM_L_drop_sub
            (fun x hx => hM_L_sub x (List.mem_of_mem_dropLast hx)) w h_in)
      have hw_notin_M_R_drop : w ∉ M_R.refactor_vertices.dropLast := fun h_in =>
        hw_notW (refactor_Walk.refactor_arm_dropLast_in_W hM_bif hM_W
            (fun x hx => hM_R_sub x (List.mem_of_mem_dropLast hx)) hM_R_drop_sub w h_in)
      -- qv = M_L.refactor_comp L_g: refactor_vertices_comp.
      have h_qv_vs : (M_L.refactor_comp L_g).refactor_vertices
                       = M_L.refactor_vertices.dropLast ++ L_g.refactor_vertices :=
        refactor_Walk.refactor_vertices_comp M_L L_g
      have h_qw_vs : (M_R.refactor_comp R_g).refactor_vertices
                       = M_R.refactor_vertices.dropLast ++ R_g.refactor_vertices :=
        refactor_Walk.refactor_vertices_comp M_R R_g
      have h_L_g_ne : L_g.refactor_vertices ≠ [] :=
        refactor_Walk.refactor_vertices_ne_nil L_g
      have h_R_g_ne : R_g.refactor_vertices ≠ [] :=
        refactor_Walk.refactor_vertices_ne_nil R_g
      have h_qv_drop :
          (M_L.refactor_comp L_g).refactor_vertices.dropLast
            = M_L.refactor_vertices.dropLast ++ L_g.refactor_vertices.dropLast := by
        rw [h_qv_vs]; exact List.dropLast_append_of_ne_nil h_L_g_ne
      have h_qw_drop :
          (M_R.refactor_comp R_g).refactor_vertices.dropLast
            = M_R.refactor_vertices.dropLast ++ R_g.refactor_vertices.dropLast := by
        rw [h_qw_vs]; exact List.dropLast_append_of_ne_nil h_R_g_ne
      have hu_notin_qv_drop : u ∉ (M_L.refactor_comp L_g).refactor_vertices.dropLast := by
        rw [h_qv_drop]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_L
        · exact hu_notin_M_L_drop h_M
        · exact hu_notin_L_g_drop h_L
      have hu_notin_qw : u ∉ (M_R.refactor_comp R_g).refactor_vertices := by
        rw [h_qw_vs]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_R
        · exact hu_notin_M_R_drop h_M
        · exact hu_notin_R_g h_R
      have hw_notin_qv : w ∉ (M_L.refactor_comp L_g).refactor_vertices := by
        rw [h_qv_vs]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_L
        · exact hw_notin_M_L_drop h_M
        · exact hw_notin_L_g h_L
      have hw_notin_qw_drop : w ∉ (M_R.refactor_comp R_g).refactor_vertices.dropLast := by
        rw [h_qw_drop]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_R
        · exact hw_notin_M_R_drop h_M
        · exact hw_notin_R_g_drop h_R
      refine ⟨refactor_Walk.refactor_mkBifurcation (M_L.refactor_comp L_g)
                hqv_dir hqv_pos (M_R.refactor_comp R_g), ?_⟩
      have h_bif_src :=
        refactor_Walk.refactor_mkBifurcation_isBifurcationSource
          (M_L.refactor_comp L_g) hqv_dir hqv_pos
          (M_R.refactor_comp R_g) hqw_dir hqw_pos
          huw_ne hu_notin_qv_drop hu_notin_qw hw_notin_qv hw_notin_qw_drop
      exact refactor_Walk.refactor_isBifurcationSource_to_isBifurcation _ c_M h_bif_src
    · -- Inl + bidirected M-hinge.
      obtain ⟨vML, vMR, M_L, M_R, hM_L_dir, hM_R_dir, hMLR, _,
              hM_L_sub, hM_R_sub, hM_L_drop_sub, hM_R_drop_sub⟩ :=
        refactor_Walk.refactor_exists_arms_of_bifurcation_bidir_hinge_strong
      ...
      have hw_notin_M_R_drop : w ∉ M_R.refactor_vertices.dropLast := fun h_in =>
        hw_notW (refactor_Walk.refactor_arm_dropLast_in_W hM_bif hM_W
            (fun x hx => hM_R_sub x (List.mem_of_mem_dropLast hx)) hM_R_drop_sub w h_in)
      have h_Lc_vs : (M_L.refactor_comp L_g).refactor_vertices
                       = M_L.refactor_vertices.dropLast ++ L_g.refactor_vertices :=
        refactor_Walk.refactor_vertices_comp M_L L_g
      have h_Rc_vs : (M_R.refactor_comp R_g).refactor_vertices
                       = M_R.refactor_vertices.dropLast ++ R_g.refactor_vertices :=
        refactor_Walk.refactor_vertices_comp M_R R_g
      have h_L_g_ne : L_g.refactor_vertices ≠ [] :=
        refactor_Walk.refactor_vertices_ne_nil L_g
      ...
      have h_Rc_drop :
          (M_R.refactor_comp R_g).refactor_vertices.dropLast
            = M_R.refactor_vertices.dropLast ++ R_g.refactor_vertices.dropLast := by
        rw [h_Rc_vs]; exact List.dropLast_append_of_ne_nil h_R_g_ne
      have hu_notin_Lc_drop : u ∉ (M_L.refactor_comp L_g).refactor_vertices.dropLast := by
        rw [h_Lc_drop]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_L
        · exact hu_notin_M_L_drop h_M
        · exact hu_notin_L_g_drop h_L
      have hu_notin_Rc : u ∉ (M_R.refactor_comp R_g).refactor_vertices := by
        rw [h_Rc_vs]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_R
        · exact hu_notin_M_R_drop h_M
        · exact hu_notin_R_g h_R
      have hw_notin_Lc : w ∉ (M_L.refactor_comp L_g).refactor_vertices := by
        rw [h_Lc_vs]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_L
        · exact hw_notin_M_L_drop h_M
        · exact hw_notin_L_g h_L
      have hw_notin_Rc_drop : w ∉ (M_R.refactor_comp R_g).refactor_vertices.dropLast := by
        rw [h_Rc_drop]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_R
        · exact hw_notin_M_R_drop h_M
      ...
      refine ⟨refactor_Walk.refactor_mkBifurcationBidir
                (M_L.refactor_comp L_g) hLc_dir (M_R.refactor_comp R_g) hMLR, ?_⟩
      exact refactor_Walk.refactor_mkBifurcationBidir_isBifurcation
        (M_L.refactor_comp L_g) hLc_dir
        (M_R.refactor_comp R_g) hRc_dir hMLR huw_ne hu_notin_Lc_drop hu_notin_Rc
        hw_notin_Lc hw_notin_Rc_drop
  · -- inr case: M : refactor_Walk G vR vL.
    have hM_split_ex : ∃ i, M.refactor_IsBifurcationWithSplit i := hM_bif.2.2.2
    obtain ⟨k_M, hM_split⟩ := hM_split_ex
    by_cases h_M_dir : M.refactor_IsBifurcationDirectedHingeWithSplit k_M
    · -- Inr + directed M-hinge.
      obtain ⟨c_M, M_L, M_R, hM_L_dir, hM_R_dir, hM_L_pos, hM_R_pos, _,
        ...
        refactor_Walk.refactor_exists_arms_of_bifurcation_directed_hinge_strong
          M k_M h_M_dir
      have hqv_dir : (M_R.refactor_comp L_g).refactor_IsDirectedWalk :=
        refactor_Walk.refactor_isDirectedWalk_comp M_R L_g hM_R_dir hL_g_dir
      have hqw_dir : (M_L.refactor_comp R_g).refactor_IsDirectedWalk :=
        refactor_Walk.refactor_isDirectedWalk_comp M_L R_g hM_L_dir hR_g_dir
      have hqv_pos : (M_R.refactor_comp L_g).refactor_length ≥ 1 := by
        rw [refactor_Walk.refactor_length_comp]; omega
      have hqw_pos : (M_L.refactor_comp R_g).refactor_length ≥ 1 := by
        rw [refactor_Walk.refactor_length_comp]; omega
      have hu_notin_M_L_drop : u ∉ M_L.refactor_vertices.dropLast := fun h_in =>
        hu_notW (refactor_Walk.refactor_arm_dropLast_in_W hM_bif hM_W hM_L_drop_sub
            (fun x hx => hM_L_sub x (List.mem_of_mem_dropLast hx)) u h_in)
      ...
      have hw_notin_M_R_drop : w ∉ M_R.refactor_vertices.dropLast := fun h_in =>
        hw_notW (refactor_Walk.refactor_arm_dropLast_in_W hM_bif hM_W
            (fun x hx => hM_R_sub x (List.mem_of_mem_dropLast hx)) hM_R_drop_sub w h_in)
      have h_qv_vs : (M_R.refactor_comp L_g).refactor_vertices
                       = M_R.refactor_vertices.dropLast ++ L_g.refactor_vertices :=
        refactor_Walk.refactor_vertices_comp M_R L_g
      have h_qw_vs : (M_L.refactor_comp R_g).refactor_vertices
                       = M_L.refactor_vertices.dropLast ++ R_g.refactor_vertices :=
      ...
      have h_qv_drop :
        ...
        rw [h_qv_vs]; exact List.dropLast_append_of_ne_nil h_L_g_ne
      have h_qw_drop :
          (M_L.refactor_comp R_g).refactor_vertices.dropLast
            = M_L.refactor_vertices.dropLast ++ R_g.refactor_vertices.dropLast := by
        rw [h_qw_vs]; exact List.dropLast_append_of_ne_nil h_R_g_ne
      have hu_notin_qv_drop : u ∉ (M_R.refactor_comp L_g).refactor_vertices.dropLast := by
        rw [h_qv_drop]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_L
        · exact hu_notin_M_R_drop h_M
        · exact hu_notin_L_g_drop h_L
      have hu_notin_qw : u ∉ (M_L.refactor_comp R_g).refactor_vertices := by
        rw [h_qw_vs]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_R
        · exact hu_notin_M_L_drop h_M
        · exact hu_notin_R_g h_R
      have hw_notin_qv : w ∉ (M_R.refactor_comp L_g).refactor_vertices := by
        rw [h_qv_vs]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_L
        · exact hw_notin_M_R_drop h_M
        · exact hw_notin_L_g h_L
      have hw_notin_qw_drop : w ∉ (M_L.refactor_comp R_g).refactor_vertices.dropLast := by
        rw [h_qw_drop]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_R
        · exact hw_notin_M_L_drop h_M
        · exact hw_notin_R_g_drop h_R
      refine ⟨refactor_Walk.refactor_mkBifurcation (M_R.refactor_comp L_g)
                hqv_dir hqv_pos (M_L.refactor_comp R_g), ?_⟩
      have h_bif_src :=
        refactor_Walk.refactor_mkBifurcation_isBifurcationSource
          (M_R.refactor_comp L_g) hqv_dir hqv_pos
          (M_L.refactor_comp R_g) hqw_dir hqw_pos
          huw_ne hu_notin_qv_drop hu_notin_qw hw_notin_qv hw_notin_qw_drop
      exact refactor_Walk.refactor_isBifurcationSource_to_isBifurcation _ c_M h_bif_src
    · -- Inr + bidirected M-hinge.
      obtain ⟨vML, vMR, M_L, M_R, hM_L_dir, hM_R_dir, hMLR, _,
      ...
      have hw_notin_M_R_drop : w ∉ M_R.refactor_vertices.dropLast := fun h_in =>
        hw_notW (refactor_Walk.refactor_arm_dropLast_in_W hM_bif hM_W
            (fun x hx => hM_R_sub x (List.mem_of_mem_dropLast hx)) hM_R_drop_sub w h_in)
      have h_Lc_vs : (M_R.refactor_comp L_g).refactor_vertices
                       = M_R.refactor_vertices.dropLast ++ L_g.refactor_vertices :=
        refactor_Walk.refactor_vertices_comp M_R L_g
      have h_Rc_vs : (M_L.refactor_comp R_g).refactor_vertices
                       = M_L.refactor_vertices.dropLast ++ R_g.refactor_vertices :=
        refactor_Walk.refactor_vertices_comp M_L R_g
      have h_L_g_ne : L_g.refactor_vertices ≠ [] :=
        refactor_Walk.refactor_vertices_ne_nil L_g
      ...
      have h_Rc_drop :
          (M_L.refactor_comp R_g).refactor_vertices.dropLast
            = M_L.refactor_vertices.dropLast ++ R_g.refactor_vertices.dropLast := by
        rw [h_Rc_vs]; exact List.dropLast_append_of_ne_nil h_R_g_ne
      have hu_notin_Lc_drop : u ∉ (M_R.refactor_comp L_g).refactor_vertices.dropLast := by
        rw [h_Lc_drop]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_L
        · exact hu_notin_M_R_drop h_M
        · exact hu_notin_L_g_drop h_L
      have hu_notin_Rc : u ∉ (M_L.refactor_comp R_g).refactor_vertices := by
        rw [h_Rc_vs]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_R
        · exact hu_notin_M_L_drop h_M
        · exact hu_notin_R_g h_R
      have hw_notin_Lc : w ∉ (M_R.refactor_comp L_g).refactor_vertices := by
        rw [h_Lc_vs]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_L
        · exact hw_notin_M_R_drop h_M
        · exact hw_notin_L_g h_L
      have hw_notin_Rc_drop : w ∉ (M_L.refactor_comp R_g).refactor_vertices.dropLast := by
        rw [h_Rc_drop]
        intro h_in
        rcases List.mem_append.mp h_in with h_M | h_R
        · exact hw_notin_M_L_drop h_M
        · exact hw_notin_R_g_drop h_R
      refine ⟨refactor_Walk.refactor_mkBifurcationBidir
                (M_R.refactor_comp L_g) hLc_dir (M_L.refactor_comp R_g) hMLR_sym, ?_⟩
      exact refactor_Walk.refactor_mkBifurcationBidir_isBifurcation
        (M_R.refactor_comp L_g) hLc_dir
        (M_L.refactor_comp R_g) hRc_dir hMLR_sym huw_ne hu_notin_Lc_drop hu_notin_Rc
        hw_notin_Lc hw_notin_Rc_drop
...
-- structural/mechanical ports against the typed-`refactor_WalkStep`
...
-- `refactor_marginalize_L_iff` (Batch 1 net-new helper); the bidirected
...
* Single-edge witness `Walk.cons vR (vL, vR) (Or.inl ⟨rfl, Or.inr hLR⟩) (Walk.nil ...)`
  collapses to `refactor_Walk.cons vR (.bidir hLR_G) (refactor_Walk.nil vR hvR_g)`.
* `(vL, vR) ∈ marg.L` goes via `refactor_marginalize_L_iff` (Sym2-image
  unwrap); the Φ_L witness is `Or.inl ⟨single, h_single_bif, h_single_W⟩`
  per the unchanged Φ_L shape. -/
lemma refactor_marg_bif_forward_bidir_both_notW
    (G : refactor_CDMG Node) (W : Finset Node) (hW : W ⊆ G.V) {u w : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    {p : refactor_Walk G u w} (hp : p.refactor_IsBifurcation)
    {vL vR : Node}
    (hvL_notW : vL ∉ W) (hvR_notW : vR ∉ W)
    (L_g : refactor_Walk G vL u) (R_g : refactor_Walk G vR w)
    (hL_dir : L_g.refactor_IsDirectedWalk) (hR_dir : R_g.refactor_IsDirectedWalk)
    (hLR_G : s(vL, vR) ∈ G.L)
    (hL_sub : ∀ x ∈ L_g.refactor_vertices, x ∈ p.refactor_vertices.dropLast)
    (hR_sub : ∀ x ∈ R_g.refactor_vertices, x ∈ p.refactor_vertices.tail)
    (hL_drop_sub : ∀ x ∈ L_g.refactor_vertices.dropLast, x ∈ p.refactor_vertices.tail)
    (hR_drop_sub : ∀ x ∈ R_g.refactor_vertices.dropLast, x ∈ p.refactor_vertices.dropLast) :
    ∃ q : refactor_Walk (G.refactor_marginalize W hW) u w,
      q.refactor_IsBifurcation := by
  obtain ⟨huw_ne, hu_tail, hw_drop, _, _⟩ := hp
  ...
  let single : refactor_Walk G vL vR :=
    refactor_Walk.cons vR (.bidir hLR_G) (refactor_Walk.nil vR hvR_g)
  have h_single_bif : single.refactor_IsBifurcation :=
    refactor_Walk.refactor_singleEdge_isBifurcation_of_bidir hvL_g hvR_g hLR_G hvLvR_ne
  have h_single_W : ∀ x ∈ single.refactor_vertices.tail.dropLast, x ∈ W := by
    intro x hx
    change x ∈ ([vL, vR] : List Node).tail.dropLast at hx
    simp at hx
  -- s(vL, vR) ∈ marg.L via Φ_L (Sym2-image unwrap helper).
  have hLR_marg : s(vL, vR) ∈ (G.refactor_marginalize W hW).L :=
    (refactor_marginalize_L_iff G W hW).mpr
  ...
  -- Verify the four vertex-bound conditions for mkBifurcationBidir_isBifurcation.
  have hu_notin_L_drop : u ∉ L_marg.refactor_vertices.dropLast := fun h_in =>
    hu_tail (hL_drop_sub u (hL_marg_drop_sub u h_in))
  have hu_notin_R : u ∉ R_marg.refactor_vertices := fun h_in =>
    hu_tail (hR_sub u (hR_marg_sub u h_in))
  have hw_notin_L : w ∉ L_marg.refactor_vertices := fun h_in =>
    hw_drop (hL_sub w (hL_marg_sub w h_in))
  have hw_notin_R_drop : w ∉ R_marg.refactor_vertices.dropLast := fun h_in =>
    hw_drop (hR_drop_sub w (hR_marg_drop_sub w h_in))
  refine ⟨refactor_Walk.refactor_mkBifurcationBidir L_marg hL_marg_dir R_marg hLR_marg, ?_⟩
  exact refactor_Walk.refactor_mkBifurcationBidir_isBifurcation
    L_marg hL_marg_dir R_marg hR_marg_dir hLR_marg
    huw_ne hu_notin_L_drop hu_notin_R hw_notin_L hw_notin_R_drop
...
`refactor_marginalize_L_iff`.  No `hL_irrefl` site here. -/
lemma refactor_marg_bif_forward_assemble_bidirected
    (G : refactor_CDMG Node) (W : Finset Node) (hW : W ⊆ G.V) {u w : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    (huw_ne : u ≠ w)
    {vL_exit vR_exit : Node}
    (hvL_exit_VW : vL_exit ∈ G.V \ W) (hvR_exit_VW : vR_exit ∈ G.V \ W)
    (hvL_vR_exit_eq : vL_exit ≠ vR_exit)
    (hPhi_L : G.refactor_MarginalizationΦL W vL_exit vR_exit)
    {L_marg_seg : refactor_Walk G vL_exit u}
    (hL_marg_dir : L_marg_seg.refactor_IsDirectedWalk)
    {R_marg_seg : refactor_Walk G vR_exit w}
    (hR_marg_dir : R_marg_seg.refactor_IsDirectedWalk)
    (hu_notin_L_drop : u ∉ L_marg_seg.refactor_vertices.dropLast)
    (hu_notin_R : u ∉ R_marg_seg.refactor_vertices)
    (hw_notin_L : w ∉ L_marg_seg.refactor_vertices)
    (hw_notin_R_drop : w ∉ R_marg_seg.refactor_vertices.dropLast) :
    ∃ q : refactor_Walk (G.refactor_marginalize W hW) u w,
      q.refactor_IsBifurcation := by
  ...
  have hvR_marg : vR_exit ∈ G.refactor_marginalize W hW := by
    change vR_exit ∈ G.J ∪ (G.V \ W); exact Finset.mem_union_right _ hvR_exit_VW
  have hLR_marg : s(vL_exit, vR_exit) ∈ (G.refactor_marginalize W hW).L :=
    (refactor_marginalize_L_iff G W hW).mpr
  ...
  have hu_notin_L_proj_drop : u ∉ L_marg_proj.refactor_vertices.dropLast := fun h_in =>
    hu_notin_L_drop (hL_marg_proj_drop_sub u h_in)
  have hu_notin_R_proj : u ∉ R_marg_proj.refactor_vertices := fun h_in =>
    hu_notin_R (hR_marg_proj_sub u h_in)
  have hw_notin_L_proj : w ∉ L_marg_proj.refactor_vertices := fun h_in =>
    hw_notin_L (hL_marg_proj_sub w h_in)
  have hw_notin_R_proj_drop : w ∉ R_marg_proj.refactor_vertices.dropLast := fun h_in =>
    hw_notin_R_drop (hR_marg_proj_drop_sub w h_in)
  refine ⟨refactor_Walk.refactor_mkBifurcationBidir L_marg_proj hL_marg_proj_dir
            R_marg_proj hLR_marg, ?_⟩
  exact refactor_Walk.refactor_mkBifurcationBidir_isBifurcation L_marg_proj hL_marg_proj_dir
    R_marg_proj hR_marg_proj_dir hLR_marg huw_ne
    hu_notin_L_proj_drop hu_notin_R_proj hw_notin_L_proj hw_notin_R_proj_drop
...
byte-identical modulo the `vertices` → `refactor_vertices` rename. -/
lemma refactor_marg_bif_forward_dir_hinge_src_W
    (G : refactor_CDMG Node) (W : Finset Node) (hW : W ⊆ G.V) {u w : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    {p : refactor_Walk G u w} (hp : p.refactor_IsBifurcation)
    {i : ℕ} (h_dir : p.refactor_IsBifurcationDirectedHingeWithSplit i)
  ...
  have hu_notW : u ∉ W := refactor_notW_of_mem_marginalize hW hu
  have hw_notW : w ∉ W := refactor_notW_of_mem_marginalize hW hw
  have hc_in_p : c ∈ p.refactor_vertices := List.mem_of_getElem? hidx
  have hc_g : c ∈ G := refactor_Walk.refactor_mem_of_mem_vertices p hc_in_p
  have hc_W : c ∈ W := by
    by_contra hc_notW
    apply hc_notin_marg
    change c ∈ G.J ∪ (G.V \ W)
  ...
  obtain ⟨vL_exit, L_W_seg, L_marg_seg, hL_W_dir, hL_marg_dir, hL_W_pos,
          hvL_exit_notW, hL_W_inter, _hL_lens_eq, hL_p_vs_eq⟩ :=
    refactor_find_first_non_W_directed W L_p hL_p_dir hL_p_pos hu_notW
  obtain ⟨vR_exit, R_W_seg, R_marg_seg, hR_W_dir, hR_marg_dir, hR_W_pos,
          hvR_exit_notW, hR_W_inter, _hR_lens_eq, hR_p_vs_eq⟩ :=
    refactor_find_first_non_W_directed W R_p hR_p_dir hR_p_pos hw_notW
  have hvL_exit_GV : vL_exit ∈ G.V :=
  ...
  have hR_marg_drop_sub_R_p_drop :
    ...
    rw [hR_p_vs_eq, List.dropLast_append_of_ne_nil hR_marg_ne]
    exact List.mem_append.mpr (Or.inr hx)
  have hu_notin_L_marg_drop : u ∉ L_marg_seg.refactor_vertices.dropLast := fun h_in =>
    hu_tail (hL_p_drop_sub u (hL_marg_drop_sub_L_p_drop u h_in))
  have hu_notin_R_marg : u ∉ R_marg_seg.refactor_vertices := fun h_in =>
    hu_tail (hR_p_sub u (hR_marg_sub_R_p u h_in))
  have hw_notin_L_marg : w ∉ L_marg_seg.refactor_vertices := fun h_in =>
    hw_drop (hL_p_sub w (hL_marg_sub_L_p w h_in))
  have hw_notin_R_marg_drop : w ∉ R_marg_seg.refactor_vertices.dropLast := fun h_in =>
    hw_drop (hR_p_drop_sub w (hR_marg_drop_sub_R_p_drop w h_in))
  -- L_W_seg vertex bounds.
  have hL_W_sub_L_p : ∀ x ∈ L_W_seg.refactor_vertices, x ∈ L_p.refactor_vertices := by
    intro x hx
    rw [hL_p_vs_eq]
    by_cases h_drop : x ∈ L_W_seg.refactor_vertices.dropLast
    · exact List.mem_append.mpr (Or.inl h_drop)
    · have h_x_last : x = vL_exit := by
        have h_W_seg_ne : L_W_seg.refactor_vertices ≠ [] :=
          refactor_Walk.refactor_vertices_ne_nil L_W_seg
        have h_W_seg_last :
            L_W_seg.refactor_vertices.getLast h_W_seg_ne = vL_exit :=
          refactor_Walk.refactor_vertices_getLast L_W_seg
        have := List.dropLast_append_getLast h_W_seg_ne
        rw [h_W_seg_last] at this
        have hx_in : x ∈ L_W_seg.refactor_vertices.dropLast ++ [vL_exit] := by
          rw [this]; exact hx
        rcases List.mem_append.mp hx_in with h | h
        · exact absurd h h_drop
        · exact List.mem_singleton.mp h
      ...
      apply List.mem_append.mpr
      right
      exact refactor_Walk.refactor_head_mem_vertices L_marg_seg
  have hR_W_sub_R_p : ∀ x ∈ R_W_seg.refactor_vertices, x ∈ R_p.refactor_vertices := by
    intro x hx
    rw [hR_p_vs_eq]
    by_cases h_drop : x ∈ R_W_seg.refactor_vertices.dropLast
    · exact List.mem_append.mpr (Or.inl h_drop)
    · have h_x_last : x = vR_exit := by
        have h_W_seg_ne : R_W_seg.refactor_vertices ≠ [] :=
          refactor_Walk.refactor_vertices_ne_nil R_W_seg
        have h_W_seg_last :
            R_W_seg.refactor_vertices.getLast h_W_seg_ne = vR_exit :=
          refactor_Walk.refactor_vertices_getLast R_W_seg
        have := List.dropLast_append_getLast h_W_seg_ne
        rw [h_W_seg_last] at this
        have hx_in : x ∈ R_W_seg.refactor_vertices.dropLast ++ [vR_exit] := by
          rw [this]; exact hx
        rcases List.mem_append.mp hx_in with h | h
        · exact absurd h h_drop
        · exact List.mem_singleton.mp h
      ...
      apply List.mem_append.mpr
      right
      exact refactor_Walk.refactor_head_mem_vertices R_marg_seg
  by_cases hvL_vR_exit_eq : vL_exit = vR_exit
  · -- Degenerate case: build sourced G-bifurcation.
    subst hvL_vR_exit_eq
    have hvL_exit_ne_u : vL_exit ≠ u := by
      intro h_eq
      have hvL_in_R_p_tail : vL_exit ∈ R_p.refactor_vertices := hR_marg_sub_R_p _
        (refactor_Walk.refactor_head_mem_vertices R_marg_seg)
      have hvL_in_p_tail : vL_exit ∈ p.refactor_vertices.tail :=
        hR_p_sub _ hvL_in_R_p_tail
      exact hu_tail (h_eq ▸ hvL_in_p_tail)
    have hvL_exit_ne_w : vL_exit ≠ w := by
      intro h_eq
      have hvL_in_L_p : vL_exit ∈ L_p.refactor_vertices := hL_marg_sub_L_p _
        (refactor_Walk.refactor_head_mem_vertices L_marg_seg)
      have hvL_in_p_drop : vL_exit ∈ p.refactor_vertices.dropLast :=
        hL_p_sub _ hvL_in_L_p
      exact hw_drop (h_eq ▸ hvL_in_p_drop)
    have hL_marg_pos : L_marg_seg.refactor_length ≥ 1 :=
      refactor_Walk.refactor_length_pos_of_ne L_marg_seg hvL_exit_ne_u
    have hR_marg_pos : R_marg_seg.refactor_length ≥ 1 :=
      refactor_Walk.refactor_length_pos_of_ne R_marg_seg hvL_exit_ne_w
    have hvL_marg : vL_exit ∈ G.refactor_marginalize W hW := by
      change vL_exit ∈ G.J ∪ (G.V \ W); exact Finset.mem_union_right _ hvL_exit_VW
    have h_src :
        (refactor_Walk.refactor_mkBifurcation L_marg_seg hL_marg_dir hL_marg_pos
            R_marg_seg).refactor_IsBifurcationSource vL_exit :=
      refactor_Walk.refactor_mkBifurcation_isBifurcationSource
        L_marg_seg hL_marg_dir hL_marg_pos
        R_marg_seg hR_marg_dir hR_marg_pos huw_ne
        hu_notin_L_marg_drop hu_notin_R_marg hw_notin_L_marg hw_notin_R_marg_drop
    obtain ⟨q, hq_src⟩ :=
      refactor_marg_preserves_bifSource_forward G W hW hu hw hvL_marg
        ⟨_, h_src⟩
    exact ⟨q, refactor_Walk.refactor_isBifurcationSource_to_isBifurcation
              q vL_exit hq_src⟩
  · -- Non-degenerate case: build Φ_L witness via mkBifurcation L_W_seg R_W_seg.
    have hvL_notin_L_W_drop : vL_exit ∉ L_W_seg.refactor_vertices.dropLast := by
      intro h_in
      have h_W_seg_tail_ne : L_W_seg.refactor_vertices.tail ≠ [] :=
        refactor_Walk.refactor_tail_vertices_ne_nil_of_pos L_W_seg hL_W_pos
      have h_vs_eq : L_W_seg.refactor_vertices = c :: L_W_seg.refactor_vertices.tail :=
        refactor_Walk.refactor_vertices_eq_head_cons_tail L_W_seg
      rw [h_vs_eq, List.dropLast_cons_of_ne_nil h_W_seg_tail_ne] at h_in
      rcases List.mem_cons.mp h_in with h_eq | h_rest
      · exact hvL_exit_notW (h_eq ▸ hc_W)
      · exact hvL_exit_notW (hL_W_inter vL_exit h_rest)
    have hvR_notin_R_W_drop : vR_exit ∉ R_W_seg.refactor_vertices.dropLast := by
      intro h_in
      have h_W_seg_tail_ne : R_W_seg.refactor_vertices.tail ≠ [] :=
        refactor_Walk.refactor_tail_vertices_ne_nil_of_pos R_W_seg hR_W_pos
      have h_vs_eq : R_W_seg.refactor_vertices = c :: R_W_seg.refactor_vertices.tail :=
        refactor_Walk.refactor_vertices_eq_head_cons_tail R_W_seg
      rw [h_vs_eq, List.dropLast_cons_of_ne_nil h_W_seg_tail_ne] at h_in
      rcases List.mem_cons.mp h_in with h_eq | h_rest
      · exact hvR_exit_notW (h_eq ▸ hc_W)
      · exact hvR_exit_notW (hR_W_inter vR_exit h_rest)
    have h_R_W_target : R_W_seg.refactor_vertices.tail.getLast
        (refactor_Walk.refactor_tail_vertices_ne_nil_of_pos R_W_seg hR_W_pos) = vR_exit :=
      refactor_Walk.refactor_tail_getLast_of_pos R_W_seg hR_W_pos
    have h_L_W_target : L_W_seg.refactor_vertices.tail.getLast
        (refactor_Walk.refactor_tail_vertices_ne_nil_of_pos L_W_seg hL_W_pos) = vL_exit :=
      refactor_Walk.refactor_tail_getLast_of_pos L_W_seg hL_W_pos
    have hvL_notin_R_W : vL_exit ∉ R_W_seg.refactor_vertices := by
      intro h_in
      have h_R_W_tail_ne : R_W_seg.refactor_vertices.tail ≠ [] :=
        refactor_Walk.refactor_tail_vertices_ne_nil_of_pos R_W_seg hR_W_pos
      have h_vs_eq : R_W_seg.refactor_vertices = c :: R_W_seg.refactor_vertices.tail :=
        refactor_Walk.refactor_vertices_eq_head_cons_tail R_W_seg
      rw [h_vs_eq] at h_in
      rcases List.mem_cons.mp h_in with h_eq | h_rest
      · exact hvL_exit_notW (h_eq ▸ hc_W)
      · have h_tail_decomp : R_W_seg.refactor_vertices.tail
            = R_W_seg.refactor_vertices.tail.dropLast ++ [vR_exit] := by
          have := List.dropLast_append_getLast h_R_W_tail_ne
          rw [h_R_W_target] at this
          exact this.symm
        rw [h_tail_decomp] at h_rest
        ...
        · rw [List.mem_singleton] at h_eq2
          exact hvL_vR_exit_eq h_eq2
    have hvR_notin_L_W : vR_exit ∉ L_W_seg.refactor_vertices := by
      intro h_in
      have h_L_W_tail_ne : L_W_seg.refactor_vertices.tail ≠ [] :=
        refactor_Walk.refactor_tail_vertices_ne_nil_of_pos L_W_seg hL_W_pos
      have h_vs_eq : L_W_seg.refactor_vertices = c :: L_W_seg.refactor_vertices.tail :=
        refactor_Walk.refactor_vertices_eq_head_cons_tail L_W_seg
      rw [h_vs_eq] at h_in
      rcases List.mem_cons.mp h_in with h_eq | h_rest
      · exact hvR_exit_notW (h_eq ▸ hc_W)
      · have h_tail_decomp : L_W_seg.refactor_vertices.tail
            = L_W_seg.refactor_vertices.tail.dropLast ++ [vL_exit] := by
          have := List.dropLast_append_getLast h_L_W_tail_ne
          rw [h_L_W_target] at this
          exact this.symm
        rw [h_tail_decomp] at h_rest
    ...
    have h_phi_bif :
      ...
      refactor_Walk.refactor_isBifurcationSource_to_isBifurcation _ c h_phi_src
    have h_phi_W :
        ∀ x ∈ (refactor_Walk.refactor_mkBifurcation L_W_seg hL_W_dir hL_W_pos
                  R_W_seg).refactor_vertices.tail.dropLast, x ∈ W := by
      intro x hx
      have h_vs : (refactor_Walk.refactor_mkBifurcation L_W_seg hL_W_dir hL_W_pos
                      R_W_seg).refactor_vertices
          = L_W_seg.refactor_vertices.reverse.dropLast ++ R_W_seg.refactor_vertices :=
        refactor_Walk.refactor_vertices_mkBifurcation L_W_seg hL_W_dir hL_W_pos R_W_seg
      have h_rev_drop : L_W_seg.refactor_vertices.reverse.dropLast
          = L_W_seg.refactor_vertices.tail.reverse :=
        refactor_Walk.refactor_vertices_reverse_dropLast L_W_seg
      have h_L_W_tail_decomp : L_W_seg.refactor_vertices.tail
          = L_W_seg.refactor_vertices.tail.dropLast ++ [vL_exit] := by
        ...
        rw [h_L_W_target] at this
        exact this.symm
      have h_L_W_rev_eq : L_W_seg.refactor_vertices.tail.reverse
          = vL_exit :: L_W_seg.refactor_vertices.tail.dropLast.reverse := by
        conv_lhs => rw [h_L_W_tail_decomp]
        simp [List.reverse_append]
      rw [h_vs, h_rev_drop, h_L_W_rev_eq] at hx
      have h_R_W_ne : R_W_seg.refactor_vertices ≠ [] :=
        refactor_Walk.refactor_vertices_ne_nil R_W_seg
      rw [List.cons_append] at hx
      change x ∈ (L_W_seg.refactor_vertices.tail.dropLast.reverse
                    ++ R_W_seg.refactor_vertices).dropLast at hx
      rw [List.dropLast_append_of_ne_nil h_R_W_ne] at hx
      rcases List.mem_append.mp hx with h_L | h_R
      · rw [List.mem_reverse] at h_L
        exact hL_W_inter x h_L
      · have h_R_W_tail_ne : R_W_seg.refactor_vertices.tail ≠ [] :=
          refactor_Walk.refactor_tail_vertices_ne_nil_of_pos R_W_seg hR_W_pos
        have h_R_W_vs_eq : R_W_seg.refactor_vertices = c :: R_W_seg.refactor_vertices.tail :=
          refactor_Walk.refactor_vertices_eq_head_cons_tail R_W_seg
        rw [h_R_W_vs_eq, List.dropLast_cons_of_ne_nil h_R_W_tail_ne] at h_R
        rcases List.mem_cons.mp h_R with h_eq | h_rest
        · exact h_eq ▸ hc_W
        · exact hR_W_inter x h_rest
    have hPhi_L : G.refactor_MarginalizationΦL W vL_exit vR_exit := by
      left
      exact ⟨_, h_phi_bif, h_phi_W⟩
...
or assembling via `refactor_mkBifurcationBidir` + assembly helper.
Mechanical port: all `Walk.*` → `refactor_Walk.refactor_*`,
`marginalize` → `refactor_marginalize`, `IsBifurcation` →
`refactor_IsBifurcation`.  The `hLR_G : s(vL, vR) ∈ G.L` hypothesis is
Sym2-typed already at the use site, so no further conversion needed.
The cons-skip wildcards `.cons _ _ _ _` → `.cons _ _ _`. -/
lemma refactor_marg_bif_forward_bidir_finish
    (G : refactor_CDMG Node) (W : Finset Node) (hW : W ⊆ G.V) {u w : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    (huw_ne : u ≠ w)
    {vL vR vL_exit vR_exit : Node}
    ...
    (hvL_exit_VW : vL_exit ∈ G.V \ W) (hvR_exit_VW : vR_exit ∈ G.V \ W)
    (L_W_part : refactor_Walk G vL vL_exit)
    (hL_W_dir : L_W_part.refactor_IsDirectedWalk)
    (hL_W_inter : ∀ x ∈ L_W_part.refactor_vertices.tail.dropLast, x ∈ W)
    (hL_W_link : (L_W_part.refactor_length ≥ 1 ∧ vL ∈ W) ∨
                 (L_W_part.refactor_length = 0 ∧ vL = vL_exit))
    (R_W_part : refactor_Walk G vR vR_exit)
    (hR_W_dir : R_W_part.refactor_IsDirectedWalk)
    (hR_W_inter : ∀ x ∈ R_W_part.refactor_vertices.tail.dropLast, x ∈ W)
    (hR_W_link : (R_W_part.refactor_length ≥ 1 ∧ vR ∈ W) ∨
                 (R_W_part.refactor_length = 0 ∧ vR = vR_exit))
    (L_marg_part : refactor_Walk G vL_exit u)
    (hL_marg_dir : L_marg_part.refactor_IsDirectedWalk)
    (R_marg_part : refactor_Walk G vR_exit w)
    (hR_marg_dir : R_marg_part.refactor_IsDirectedWalk)
    (hu_notin_L_marg_drop : u ∉ L_marg_part.refactor_vertices.dropLast)
    (hu_notin_R_marg : u ∉ R_marg_part.refactor_vertices)
    (hw_notin_L_marg : w ∉ L_marg_part.refactor_vertices)
    (hw_notin_R_marg_drop : w ∉ R_marg_part.refactor_vertices.dropLast)
    (hvR_exit_ne_u : vR_exit ≠ u) (hvL_exit_ne_w : vL_exit ≠ w) :
    ∃ q : refactor_Walk (G.refactor_marginalize W hW) u w,
      q.refactor_IsBifurcation := by
  have hvL_exit_notW : vL_exit ∉ W := (Finset.mem_sdiff.mp hvL_exit_VW).2
  ...
  · -- Degenerate case: build sourced G-bifurcation.
    subst hvL_vR_exit_eq
    have hvL_exit_ne_u : vL_exit ≠ u := hvR_exit_ne_u
    have hL_marg_pos : L_marg_part.refactor_length ≥ 1 :=
      refactor_Walk.refactor_length_pos_of_ne L_marg_part hvL_exit_ne_u
    have hR_marg_pos : R_marg_part.refactor_length ≥ 1 :=
      refactor_Walk.refactor_length_pos_of_ne R_marg_part hvL_exit_ne_w
    have hvL_exit_marg : vL_exit ∈ G.refactor_marginalize W hW := by
      change vL_exit ∈ G.J ∪ (G.V \ W); exact Finset.mem_union_right _ hvL_exit_VW
    have h_src : (refactor_Walk.refactor_mkBifurcation L_marg_part hL_marg_dir
                    hL_marg_pos R_marg_part).refactor_IsBifurcationSource vL_exit :=
      refactor_Walk.refactor_mkBifurcation_isBifurcationSource L_marg_part hL_marg_dir
    ...
    exact ⟨q, refactor_Walk.refactor_isBifurcationSource_to_isBifurcation
              q vL_exit hq_src⟩
  · -- Non-degenerate case: build Φ_L witness via refactor_mkBifurcationBidir.
    have hvL_exit_notin_L_W_drop : vL_exit ∉ L_W_part.refactor_vertices.dropLast := by
      intro h_in
      rcases hL_W_link with ⟨hL_W_pos, hvL_W⟩ | ⟨hL_W_zero, _⟩
      · have h_tail_ne : L_W_part.refactor_vertices.tail ≠ [] :=
          refactor_Walk.refactor_tail_vertices_ne_nil_of_pos L_W_part hL_W_pos
        have h_vs_eq : L_W_part.refactor_vertices = vL :: L_W_part.refactor_vertices.tail :=
          refactor_Walk.refactor_vertices_eq_head_cons_tail L_W_part
        rw [h_vs_eq, List.dropLast_cons_of_ne_nil h_tail_ne] at h_in
        rcases List.mem_cons.mp h_in with h_eq | h_rest
        · exact hvL_exit_notW (h_eq ▸ hvL_W)
        · exact hvL_exit_notW (hL_W_inter vL_exit h_rest)
      · cases L_W_part with
        | nil _ _ => simp [refactor_Walk.refactor_vertices, List.dropLast] at h_in
        | cons _ _ _ => simp [refactor_Walk.refactor_length] at hL_W_zero
    have hvR_exit_notin_R_W_drop : vR_exit ∉ R_W_part.refactor_vertices.dropLast := by
      intro h_in
      rcases hR_W_link with ⟨hR_W_pos, hvR_W⟩ | ⟨hR_W_zero, _⟩
      · have h_tail_ne : R_W_part.refactor_vertices.tail ≠ [] :=
          refactor_Walk.refactor_tail_vertices_ne_nil_of_pos R_W_part hR_W_pos
        have h_vs_eq : R_W_part.refactor_vertices = vR :: R_W_part.refactor_vertices.tail :=
          refactor_Walk.refactor_vertices_eq_head_cons_tail R_W_part
        rw [h_vs_eq, List.dropLast_cons_of_ne_nil h_tail_ne] at h_in
        rcases List.mem_cons.mp h_in with h_eq | h_rest
        · exact hvR_exit_notW (h_eq ▸ hvR_W)
        · exact hvR_exit_notW (hR_W_inter vR_exit h_rest)
      · cases R_W_part with
        | nil _ _ => simp [refactor_Walk.refactor_vertices, List.dropLast] at h_in
        | cons _ _ _ => simp [refactor_Walk.refactor_length] at hR_W_zero
    have hvL_exit_notin_R_W : vL_exit ∉ R_W_part.refactor_vertices := by
      intro h_in
      have h_vs_eq : R_W_part.refactor_vertices = vR :: R_W_part.refactor_vertices.tail :=
        refactor_Walk.refactor_vertices_eq_head_cons_tail R_W_part
      rw [h_vs_eq] at h_in
      ...
      · rcases hR_W_link with ⟨_, hvR_W⟩ | ⟨_, hvR_eq⟩
        ...
        · exact hvL_vR_exit_eq (h_eq.trans hvR_eq)
      · rcases hR_W_link with ⟨hR_W_pos, _⟩ | ⟨hR_W_zero, _⟩
        · have h_R_W_tail_ne : R_W_part.refactor_vertices.tail ≠ [] :=
            refactor_Walk.refactor_tail_vertices_ne_nil_of_pos R_W_part hR_W_pos
          have h_R_W_target : R_W_part.refactor_vertices.tail.getLast h_R_W_tail_ne
              = vR_exit :=
            refactor_Walk.refactor_tail_getLast_of_pos R_W_part hR_W_pos
          have h_tail_decomp : R_W_part.refactor_vertices.tail
              = R_W_part.refactor_vertices.tail.dropLast ++ [vR_exit] := by
            have := List.dropLast_append_getLast h_R_W_tail_ne
            rw [h_R_W_target] at this; exact this.symm
          rw [h_tail_decomp] at h_rest
          rcases List.mem_append.mp h_rest with h_W | h_eq2
          ...
          · rw [List.mem_singleton] at h_eq2
            exact hvL_vR_exit_eq h_eq2
        · cases R_W_part with
          | nil _ _ => simp [refactor_Walk.refactor_vertices, List.tail] at h_rest
          | cons _ _ _ => simp [refactor_Walk.refactor_length] at hR_W_zero
    have hvR_exit_notin_L_W : vR_exit ∉ L_W_part.refactor_vertices := by
      intro h_in
      have h_vs_eq : L_W_part.refactor_vertices = vL :: L_W_part.refactor_vertices.tail :=
        refactor_Walk.refactor_vertices_eq_head_cons_tail L_W_part
      rw [h_vs_eq] at h_in
      ...
      · rcases hL_W_link with ⟨_, hvL_W⟩ | ⟨_, hvL_eq⟩
        ...
        · exact hvL_vR_exit_eq (hvL_eq.symm.trans h_eq.symm)
      · rcases hL_W_link with ⟨hL_W_pos, _⟩ | ⟨hL_W_zero, _⟩
        · have h_L_W_tail_ne : L_W_part.refactor_vertices.tail ≠ [] :=
            refactor_Walk.refactor_tail_vertices_ne_nil_of_pos L_W_part hL_W_pos
          have h_L_W_target : L_W_part.refactor_vertices.tail.getLast h_L_W_tail_ne
              = vL_exit :=
            refactor_Walk.refactor_tail_getLast_of_pos L_W_part hL_W_pos
          have h_tail_decomp : L_W_part.refactor_vertices.tail
              = L_W_part.refactor_vertices.tail.dropLast ++ [vL_exit] := by
            have := List.dropLast_append_getLast h_L_W_tail_ne
            rw [h_L_W_target] at this; exact this.symm
          rw [h_tail_decomp] at h_rest
          rcases List.mem_append.mp h_rest with h_W | h_eq2
    ...
    -- Construct Φ_L witness.
    have h_phi_bif :
        (refactor_Walk.refactor_mkBifurcationBidir L_W_part hL_W_dir
            R_W_part hLR_G).refactor_IsBifurcation :=
      refactor_Walk.refactor_mkBifurcationBidir_isBifurcation L_W_part hL_W_dir
        R_W_part hR_W_dir hLR_G hvL_vR_exit_eq
        hvL_exit_notin_L_W_drop hvL_exit_notin_R_W
        hvR_exit_notin_L_W hvR_exit_notin_R_W_drop
    have h_phi_W : ∀ x ∈ (refactor_Walk.refactor_mkBifurcationBidir L_W_part hL_W_dir
                            R_W_part hLR_G).refactor_vertices.tail.dropLast, x ∈ W := by
      intro x hx
      have h_vs : (refactor_Walk.refactor_mkBifurcationBidir L_W_part hL_W_dir
                      R_W_part hLR_G).refactor_vertices
          = L_W_part.refactor_vertices.reverse.dropLast
              ++ (vL :: R_W_part.refactor_vertices) :=
        refactor_Walk.refactor_vertices_mkBifurcationBidir L_W_part hL_W_dir R_W_part hLR_G
      rw [h_vs] at hx
      have h_R_W_cons_ne : (vL :: R_W_part.refactor_vertices) ≠ [] := by simp
      rcases hL_W_link with ⟨hL_W_pos, hvL_W⟩ | ⟨hL_W_zero, _⟩
      · have h_L_W_rev_drop : L_W_part.refactor_vertices.reverse.dropLast
            = L_W_part.refactor_vertices.tail.reverse :=
          refactor_Walk.refactor_vertices_reverse_dropLast L_W_part
        rw [h_L_W_rev_drop] at hx
        have h_L_W_tail_ne : L_W_part.refactor_vertices.tail ≠ [] :=
          refactor_Walk.refactor_tail_vertices_ne_nil_of_pos L_W_part hL_W_pos
        have h_L_W_rev_ne : L_W_part.refactor_vertices.tail.reverse ≠ [] := by
          intro h
          apply h_L_W_tail_ne
          have := List.reverse_eq_nil_iff.mp h
          exact this
        ...
        · have h_L_W_target : L_W_part.refactor_vertices.tail.getLast h_L_W_tail_ne
              = vL_exit :=
            refactor_Walk.refactor_tail_getLast_of_pos L_W_part hL_W_pos
          have h_L_W_tail_decomp : L_W_part.refactor_vertices.tail
              = L_W_part.refactor_vertices.tail.dropLast ++ [vL_exit] := by
            have := List.dropLast_append_getLast h_L_W_tail_ne
            rw [h_L_W_target] at this; exact this.symm
          have h_L_W_rev_eq : L_W_part.refactor_vertices.tail.reverse
              = vL_exit :: L_W_part.refactor_vertices.tail.dropLast.reverse := by
            conv_lhs => rw [h_L_W_tail_decomp]
            simp [List.reverse_append]
          rw [h_L_W_rev_eq, List.tail_cons] at h_L
          have h_in_dropLast : x ∈ L_W_part.refactor_vertices.tail.dropLast := by
            have := h_L
            rwa [List.mem_reverse] at this
          exact hL_W_inter x h_in_dropLast
        · rw [List.dropLast_cons_of_ne_nil
                (refactor_Walk.refactor_vertices_ne_nil R_W_part)] at h_R
          rcases List.mem_cons.mp h_R with h_eq | h_in_R_drop
          · exact h_eq ▸ hvL_W
          · rcases hR_W_link with ⟨hR_W_pos, hvR_W⟩ | ⟨hR_W_zero, _⟩
            · have h_R_tail_ne : R_W_part.refactor_vertices.tail ≠ [] :=
                refactor_Walk.refactor_tail_vertices_ne_nil_of_pos R_W_part hR_W_pos
              have h_R_vs_eq : R_W_part.refactor_vertices
                  = vR :: R_W_part.refactor_vertices.tail :=
                refactor_Walk.refactor_vertices_eq_head_cons_tail R_W_part
              rw [h_R_vs_eq, List.dropLast_cons_of_ne_nil h_R_tail_ne] at h_in_R_drop
              rcases List.mem_cons.mp h_in_R_drop with h_eq | h_rest
              · exact h_eq ▸ hvR_W
              · exact hR_W_inter x h_rest
            · cases R_W_part with
              | nil _ _ => simp [refactor_Walk.refactor_vertices, List.dropLast]
                              at h_in_R_drop
              | cons _ _ _ => simp [refactor_Walk.refactor_length] at hR_W_zero
      · have h_L_W_drop_empty : L_W_part.refactor_vertices.reverse.dropLast = [] := by
          cases L_W_part with
          | nil _ _ => rfl
          | cons _ _ _ => simp [refactor_Walk.refactor_length] at hL_W_zero
        rw [h_L_W_drop_empty, List.nil_append, List.tail_cons] at hx
        ...
        · have h_R_tail_ne : R_W_part.refactor_vertices.tail ≠ [] :=
          ...
          · exact hR_W_inter x h_rest
        · cases R_W_part with
          | nil _ _ => simp [refactor_Walk.refactor_vertices, List.dropLast] at hx
          | cons _ _ _ => simp [refactor_Walk.refactor_length] at hR_W_zero
    have hPhi_L : G.refactor_MarginalizationΦL W vL_exit vR_exit := by
      left; exact ⟨_, h_phi_bif, h_phi_W⟩
    exact refactor_marg_bif_forward_assemble_bidirected G W hW hu hw huw_ne
...
and dispatches to `refactor_marg_bif_forward_bidir_finish`.  Same
`hL_irrefl` / `hL_subset` rewrites as decl 57 (original lines
3183-3184, 3187). -/
lemma refactor_marg_bif_forward_bidir_with_W
    (G : refactor_CDMG Node) (W : Finset Node) (hW : W ⊆ G.V) {u w : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    {p : refactor_Walk G u w} (hp : p.refactor_IsBifurcation)
    {vL vR : Node}
  ...
  by_cases hvL_W : vL ∈ W
  · -- vL ∈ W: find_first_non_W on L_g.
    have hL_g_pos : L_g.refactor_length ≥ 1 :=
      refactor_Walk.refactor_length_pos_of_ne L_g (fun heq => hu_notW (heq ▸ hvL_W))
    obtain ⟨vL_exit, L_W_part, L_marg_part, hL_W_dir, hL_marg_dir, hL_W_pos,
            hvL_exit_notW, hL_W_inter, _, hL_g_vs_eq⟩ :=
      refactor_find_first_non_W_directed W L_g hL_dir hL_g_pos hu_notW
    have hvL_exit_GV : vL_exit ∈ G.V :=
      refactor_Walk.refactor_target_in_GV_of_directedWalk_pos L_W_part hL_W_dir hL_W_pos
    have hvL_exit_VW : vL_exit ∈ G.V \ W :=
      Finset.mem_sdiff.mpr ⟨hvL_exit_GV, hvL_exit_notW⟩
    have hL_marg_ne : L_marg_part.refactor_vertices ≠ [] :=
      refactor_Walk.refactor_vertices_ne_nil L_marg_part
    have hL_marg_sub_L_g :
        ∀ x ∈ L_marg_part.refactor_vertices, x ∈ L_g.refactor_vertices := fun x hx =>
      by rw [hL_g_vs_eq]; exact List.mem_append.mpr (Or.inr hx)
    have hL_marg_drop_sub_L_g_drop :
        ∀ x ∈ L_marg_part.refactor_vertices.dropLast,
          x ∈ L_g.refactor_vertices.dropLast := fun x hx => by
      rw [hL_g_vs_eq, List.dropLast_append_of_ne_nil hL_marg_ne]
      exact List.mem_append.mpr (Or.inr hx)
    have hu_notin_L_marg_drop : u ∉ L_marg_part.refactor_vertices.dropLast := fun h_in =>
      hu_tail (hL_drop_sub u (hL_marg_drop_sub_L_g_drop u h_in))
    have hw_notin_L_marg : w ∉ L_marg_part.refactor_vertices := fun h_in =>
      hw_drop (hL_sub w (hL_marg_sub_L_g w h_in))
    by_cases hvR_W : vR ∈ W
    · -- Sub-case (C): vL ∈ W AND vR ∈ W.  find_first_non_W on R_g.
      have hR_g_pos : R_g.refactor_length ≥ 1 :=
        refactor_Walk.refactor_length_pos_of_ne R_g (fun heq => hw_notW (heq ▸ hvR_W))
      obtain ⟨vR_exit, R_W_part, R_marg_part, hR_W_dir, hR_marg_dir, hR_W_pos,
              hvR_exit_notW, hR_W_inter, _, hR_g_vs_eq⟩ :=
        refactor_find_first_non_W_directed W R_g hR_dir hR_g_pos hw_notW
      have hvR_exit_GV : vR_exit ∈ G.V :=
        refactor_Walk.refactor_target_in_GV_of_directedWalk_pos R_W_part hR_W_dir hR_W_pos
      have hvR_exit_VW : vR_exit ∈ G.V \ W :=
        Finset.mem_sdiff.mpr ⟨hvR_exit_GV, hvR_exit_notW⟩
      have hR_marg_ne : R_marg_part.refactor_vertices ≠ [] :=
        refactor_Walk.refactor_vertices_ne_nil R_marg_part
      have hR_marg_sub_R_g :
          ∀ x ∈ R_marg_part.refactor_vertices, x ∈ R_g.refactor_vertices := fun x hx =>
        by rw [hR_g_vs_eq]; exact List.mem_append.mpr (Or.inr hx)
      have hR_marg_drop_sub_R_g_drop :
          ∀ x ∈ R_marg_part.refactor_vertices.dropLast,
            x ∈ R_g.refactor_vertices.dropLast := fun x hx => by
        rw [hR_g_vs_eq, List.dropLast_append_of_ne_nil hR_marg_ne]
        exact List.mem_append.mpr (Or.inr hx)
      have hu_notin_R_marg : u ∉ R_marg_part.refactor_vertices := fun h_in =>
        hu_tail (hR_sub u (hR_marg_sub_R_g u h_in))
      have hw_notin_R_marg_drop : w ∉ R_marg_part.refactor_vertices.dropLast := fun h_in =>
        hw_drop (hR_drop_sub w (hR_marg_drop_sub_R_g_drop w h_in))
      have hvR_exit_ne_u : vR_exit ≠ u := fun heq =>
        hu_tail (hR_sub _ (hR_marg_sub_R_g _
          (heq ▸ refactor_Walk.refactor_head_mem_vertices R_marg_part)))
      have hvL_exit_ne_w : vL_exit ≠ w := fun heq =>
        hw_drop (hL_sub _ (hL_marg_sub_L_g _
          (heq ▸ refactor_Walk.refactor_head_mem_vertices L_marg_part)))
    ...
    · -- Sub-case (A): vL ∈ W, vR ∉ W.  R_W_part = nil at vR, vR_exit = vR.
      ...
      have hw_notin_R_g_drop : w ∉ R_g.refactor_vertices.dropLast := fun h_in =>
        hw_drop (hR_drop_sub w h_in)
      have hvR_ne_u : vR ≠ u := fun heq =>
        hu_tail (hR_sub _ (heq ▸ refactor_Walk.refactor_head_mem_vertices R_g))
      have hvL_exit_ne_w : vL_exit ≠ w := fun heq =>
        hw_drop (hL_sub _ (hL_marg_sub_L_g _
          (heq ▸ refactor_Walk.refactor_head_mem_vertices L_marg_part)))
      have h_nil_R : (refactor_Walk.nil vR hvR_g
                        : refactor_Walk G vR vR).refactor_length = 0 := rfl
      exact refactor_marg_bif_forward_bidir_finish G W hW hu hw huw_ne
        hvL_g hvR_g hLR_G hvL_vR_ne hvL_exit_VW hvR_exit_VW
        L_W_part hL_W_dir hL_W_inter (Or.inl ⟨hL_W_pos, hvL_W⟩)
        (refactor_Walk.nil vR hvR_g) trivial
        (by intro x hx
  ...
  · -- vL ∉ W, so vR ∈ W.
    ...
    have hvR_exit_ne_u : vR_exit ≠ u := fun heq =>
      hu_tail (hR_sub _ (hR_marg_sub_R_g _
        (heq ▸ refactor_Walk.refactor_head_mem_vertices R_marg_part)))
    have hvL_ne_w : vL ≠ w := fun heq =>
      hw_drop (hL_sub _ (heq ▸ refactor_Walk.refactor_head_mem_vertices L_g))
    have h_nil_L : (refactor_Walk.nil vL hvL_g
                      : refactor_Walk G vL vL).refactor_length = 0 := rfl
    exact refactor_marg_bif_forward_bidir_finish G W hW hu hw huw_ne
      hvL_g hvR_g hLR_G hvL_vR_ne hvL_VW hvR_exit_VW
      (refactor_Walk.nil vL hvL_g) trivial
      (by intro x hx
          simp [refactor_Walk.refactor_vertices, List.tail, List.dropLast] at hx)
      (Or.inr ⟨h_nil_L, rfl⟩)
      R_W_part hR_W_dir hR_W_inter (Or.inl ⟨hR_W_pos, hvR_W⟩)
...
lemma refactor_marg_preserves_bif_forward
    (G : refactor_CDMG Node) (W : Finset Node) (hW : W ⊆ G.V) {u w : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    (h : ∃ p : refactor_Walk G u w, p.refactor_IsBifurcation) :
    ∃ q : refactor_Walk (G.refactor_marginalize W hW) u w,
      q.refactor_IsBifurcation := by
  obtain ⟨p, hp⟩ := h
  obtain ⟨i, hp_split⟩ := hp.2.2.2
  ...
  · obtain ⟨vL, vR, L_g, R_g, hL_dir, hR_dir, hLR_G, _,
            hL_sub, hR_sub, hL_drop_sub, hR_drop_sub⟩ :=
      refactor_Walk.refactor_exists_arms_of_bifurcation_bidir_hinge_strong p i hp_split h_dir
    by_cases hvL_W : vL ∈ W
...
direction of sub-claim ii(a).  Mechanical wrapper that case-splits on
hinge type. -/
lemma refactor_marg_preserves_bif_backward
    (G : refactor_CDMG Node) (W : Finset Node) (hW : W ⊆ G.V) {u w : Node}
    (hu : u ∈ G.refactor_marginalize W hW) (hw : w ∈ G.refactor_marginalize W hW)
    (h : ∃ q : refactor_Walk (G.refactor_marginalize W hW) u w,
  ...
  obtain ⟨q, hq⟩ := h
  obtain ⟨i, hq_split⟩ := hq.2.2.2
  by_cases h_dir : q.refactor_IsBifurcationDirectedHingeWithSplit i
...
-- (`Walk → refactor_Walk`, `CDMG → refactor_CDMG`,
-- `marginalize → refactor_marginalize`, `Anc → refactor_Anc`,
...
relations).  The biconditional unfolds `refactor_Anc` to the
"exists a directed `refactor_Walk`" shape; the forward direction
calls `refactor_project_directed_walk_marginalize`, the backward
direction calls `refactor_expand_directed_walk_marginalize` and
discards its extra vertex-bound conjuncts.  Identifier swaps only;
the proof structure is unchanged. -/
-- claim_3_16 -- start statement
theorem refactor_marginalize_preserves_ancestors (G : refactor_CDMG Node) (W : Finset Node)
    (hW : W ⊆ G.V) (v₁ v₂ : Node)
    (hv₁ : v₁ ∈ G.refactor_marginalize W hW) (hv₂ : v₂ ∈ G.refactor_marginalize W hW) :
    v₁ ∈ G.refactor_Anc v₂ ↔ v₁ ∈ (G.refactor_marginalize W hW).refactor_Anc v₂
-- claim_3_16 -- end statement
  := by
  constructor
  · rintro ⟨_, p, hp_dir⟩
...
helpers `refactor_marg_preserves_bif_forward` /
`refactor_marg_preserves_bif_backward` (Batch 11).  Identifier
swaps only. -/
-- claim_3_16 -- start statement
theorem refactor_marginalize_preserves_bifurcation (G : refactor_CDMG Node) (W : Finset Node)
    (hW : W ⊆ G.V) (v₁ v₂ : Node)
    (hv₁ : v₁ ∈ G.refactor_marginalize W hW) (hv₂ : v₂ ∈ G.refactor_marginalize W hW) :
    ((∃ p : refactor_Walk G v₁ v₂, p.refactor_IsBifurcation) ∨
        (∃ p : refactor_Walk G v₂ v₁, p.refactor_IsBifurcation))
      ↔
    ((∃ p : refactor_Walk (G.refactor_marginalize W hW) v₁ v₂, p.refactor_IsBifurcation) ∨
        (∃ p : refactor_Walk (G.refactor_marginalize W hW) v₂ v₁, p.refactor_IsBifurcation))
-- claim_3_16 -- end statement
  := by
  constructor
...
`refactor_marg_preserves_bifSource_forward` /
`refactor_marg_preserves_bifSource_backward` (Batch 9).  Identifier
swaps only. -/
-- claim_3_16 -- start statement
theorem refactor_marginalize_preserves_bifurcation_with_source (G : refactor_CDMG Node)
    (W : Finset Node) (hW : W ⊆ G.V) (v₁ v₂ v₃ : Node)
    (hv₁ : v₁ ∈ G.refactor_marginalize W hW) (hv₂ : v₂ ∈ G.refactor_marginalize W hW)
    (hv₃ : v₃ ∈ G.refactor_marginalize W hW) :
    ((∃ p : refactor_Walk G v₁ v₂, p.refactor_IsBifurcationSource v₃) ∨
        (∃ p : refactor_Walk G v₂ v₁, p.refactor_IsBifurcationSource v₃))
      ↔
    ((∃ p : refactor_Walk (G.refactor_marginalize W hW) v₁ v₂,
        p.refactor_IsBifurcationSource v₃) ∨
        (∃ p : refactor_Walk (G.refactor_marginalize W hW) v₂ v₁,
          p.refactor_IsBifurcationSource v₃))
-- claim_3_16 -- end statement
  := by
...
`refactor_expand_directed_walk_marginalize`, contradicting
`G.refactor_IsAcyclic`.  Identifier swaps;
`q.length` → `q.refactor_length`. -/
-- claim_3_16 -- start statement
theorem refactor_marginalize_preserves_acyclic (G : refactor_CDMG Node) (W : Finset Node)
    (hW : W ⊆ G.V) (hAcyc : G.refactor_IsAcyclic) :
    (G.refactor_marginalize W hW).refactor_IsAcyclic
-- claim_3_16 -- end statement
  := by
  intro v hv_marg ⟨p, hp_dir, hp_pos⟩
  ...
  obtain ⟨q, hq_dir, hq_len, _, _, _, _⟩ :=
    refactor_expand_directed_walk_marginalize p hp_dir
  have hq_pos : q.refactor_length ≥ 1 := by omega
  exact hAcyc v hv_g ⟨q, hq_dir, hq_pos⟩
...
`refactor_mem_of_mem_marginalize` for irreflexivity / transitivity /
trichotomy; parent-precedence unfolds the marg-`E` `Finset.filter`
to a `refactor_MarginalizationΦE` witness, then chains `lt` along
the witnessing directed `G`-walk via
`refactor_Walk.refactor_lt_of_directedWalk_pos`.  The marg-`E`
filter shape is identical to the original modulo names. -/
-- claim_3_16 -- start statement
theorem refactor_marginalize_restricts_topological_order (G : refactor_CDMG Node)
    (W : Finset Node) (hW : W ⊆ G.V)
    (lt : Node → Node → Prop) (hlt : G.refactor_IsTopologicalOrder lt) :
    (G.refactor_marginalize W hW).refactor_IsTopologicalOrder lt
-- claim_3_16 -- end statement
  := by
  obtain ⟨⟨h_irrefl, h_trans, h_total⟩, h_parent⟩ := hlt
  refine ⟨⟨?_, ?_, ?_⟩, ?_⟩
  ...
  · intro v hv w hw
    exact h_total v (refactor_mem_of_mem_marginalize hv)
                  w (refactor_mem_of_mem_marginalize hw)
  · intro v w hvw_parent
    obtain ⟨hv_marg, hvw_edge⟩ := hvw_parent
    have hvw_filter : (v, w) ∈ ((G.J ∪ (G.V \ W)) ×ˢ (G.V \ W)).filter
    ...
    have hvw_phi : G.refactor_MarginalizationΦE W v w :=
      (Finset.mem_filter.mp hvw_filter).2
    obtain ⟨p, hp_dir, hp_pos, _⟩ := hvw_phi
    exact refactor_Walk.refactor_lt_of_directedWalk_pos h_trans h_parent p hp_dir hp_pos
