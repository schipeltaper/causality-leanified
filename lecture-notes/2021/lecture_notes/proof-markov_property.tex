\subparagraph{Proofs - Global Markov Property }\hfill
...
we can directly assume that we work with the causal Bayesian networks without latent variables that marginalizes to the given one.
...
(with input variables, but without latent variables and bi-directed edges) 
with $\#V < n$ (and arbitrary $J$).\\

1.) Now assume: $\#V =n>0$ and $A \Perp^d_G J \cup B \given C$.
...
\[A \Perp^d_{G} J \cup B \given C\quad \iff \quad A \Perp^d_{G^{\sm v}} J \cup B \given C.\]
...
\begin{align*}
    A \Perp^d_G J \cup B \given C & \xRightarrow{\text{Right Decomposition}}  & A \Perp^d_G J \cup B' \given C \\
    & \xRightarrow{\text{Left Decomposition}}  & A' \Perp^d_G J \cup B' \given C \\
    & \xRightarrow{\text{marginalization, } v \notin A'\cup J \cup B' \cup C}  & A' \Perp^d_{G^{\sm \{v\}}} J \cup B' \given C \\
...
\begin{align*}
 A \Perp^d_G J \cup B \given C & \xRightarrow{\text{Right Decomposition, }B' \ins B}  & A \Perp^d_G J \cup  B' \given C   \\
  & \xRightarrow{\text{Left Weak Union, } A= A' \dcup (A \cap C) \dcup \{v\}}  & \{v\} \Perp^d_G J \cup  B' \given A' \dcup C.    \\
 & \xRightarrow{(*), \text{ see below}}  & D  \Perp^d_G J \cup  B' \given A' \dcup C \\ 
 & \xRightarrow{\text{marginalization, } v \notin D \cup J \cup B' \cup A' \cup C}  & D \Perp^d_{G^{\sm \{v\}}} J \cup B' \given A' \dcup C \\
...
A  \Perp^d_G J \cup B \given C 
& \xRightarrow{\text{Left Decomposition}}  & A' \Perp^d_G J \cup B \given C \\
& \xRightarrow{\text{Right Decomposition}}  & A' \Perp^d_G J \cup B' \given C \\
 & \xRightarrow{\text{marginalization, } v \notin A'\cup J \cup B' \cup C}  & A' \Perp^d_{G^{\sm \{v\}}} J \cup B' \given C \\
 & \xRightarrow{\text{induction (IND)}}  & X_{A'} \Indep_{P(X_V|\doit(X_J))}  X_{B'} \given X_C. \label{eqn:bli'} \tag{\#1'}
\end{align*}
Again with $D = \Pa^G(v)$ we get:
\begin{align*}
A  \Perp^d_G J \cup B \given C  & \xRightarrow{\text{Left Decomposition}}  & A' \Perp^d_G J \cup B \given C \\
 & \xRightarrow{\text{Right Decomposition}}  & A' \Perp^d_G J \cup B' \cup \{v\} \given C \\
& \xRightarrow{\text{Right Weak Union}}  & A' \Perp^d_G J \cup \{v\} \given B' \dcup C  \\
 & \xRightarrow{(\bullet), \text{ see below}}  & A'  \Perp^d_G J \cup D \given B' \dcup C \\  
...
& \xRightarrow{\text{Left Decomposition}}  & A' \Perp^d_G J \cup B \given C \\
& \xRightarrow{\text{Right Decomposition}}  & A' \Perp^d_G J \cup B' \given C \\
& \xRightarrow{C = C' \dcup \{v\}}  & A' \Perp^d_G J \cup B' \given C'\dcup\{v\} \\
\end{align*}
...
We now claim that:
\[A' \Perp^d_G J \cup B' \given C'\dcup\{v\}\]
implies that one of the following statements holds:
\[  A' \dcup \{v\} \Perp^d_G J \cup B' \given C' \qquad \lor \qquad A' \Perp^d_G J \cup (B' \dcup \{v\}) \given C'. \]
Assume the contrary:
\[  A' \dcup \{v\} \nPerp^d_G J \cup B' \given C' \qquad \land \qquad A' \nPerp^d_G J \cup (B' \dcup \{v\}) \given C'. \]
...
So all colliders of $\pi_1$ and $\pi_2$ are in $C'$ and all non-colliders outside of $C'$.
