\begin{document}
\flushleft\textbf{Topic: Introduction to Measure Theory}
...
\begin{gradedsolution}
    \begin{enumerate}
        ...
        \[
          ...
          \end{cases}
        \]
        \item Let $p_X(x)=\frac{1}{\sqrt{2\pi}} e^{-x^2/2}$ be the pdf of the standard normal function. We can directly apply 4.8.4 to obtain:
        \[
