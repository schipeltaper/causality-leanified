...
\begin{enumerate}[label=2.\arabic*]
    ...
    The bottom line, to be used in exercises \ref{ex:measurability} and \ref{ex:markov_kernel_is_bivariate_function}, is that measurability can be tested on sets which generate the $\sigma$-algebra of the codomain.
    ...
    \begin{ungradedsolution}
        ...
        If $K:\Xcal \to \Mcal(\Ycal)$ is measurable, then $\ev_B \circ K : \Xcal \to \R_{\geq 0}$ is $\Bcal_{\Xcal}$-$\Bcal_{\R_{\geq 0}}$ measurable by exercise \ref*{ex:mble_comp_is_mble} of Week 1. \\
    ...
    \emph{Hint: For doing this exercise, recall Definition \ref*{spaces_of_finite_and_prob_measures} of the $\sigma$-algebra of $\Pcal(\Wcal)$ and use exercises \ref{generating-sets} and/or \ref{ex:measurability}.}
