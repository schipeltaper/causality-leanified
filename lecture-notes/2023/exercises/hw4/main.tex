...
\begin{enumerate}
  ...
  \end{itemize}
  % !!!NEXT YEAR: Theorem 2.7.3 generalises the third result to Markov kernels. Now make the following exercises:
  Theorem 2.7 generalises the third result to Markov kernels. Now make the following exercises:
  \begin{enumerate}
    \item
