...
\begin{document}
\flushleft\textbf{Topic: Acyclification of SCMs and examples of SCMs}

\begin{enumerate}
	\item %($5$ points) 
	Given the following SCM:
	$$M = \left\langle J=\emptyset, V=\{A, B, C, D, E, F\}, W=\{A', B', C', D', E', F'\}, \R^{12}, P, f \right\rangle,$$
	...
	\begin{enumerate}
		...
		\end{enumerate}
		% TODO 23/24: Note: $\iff$ here means that left and right hand side are either both true or both false, so show this for this particular example (give active paths or prove the sigma-separation)
	\end{enumerate}
	...
	\begin{gradedsolution}
		\begin{enumerate}
			...
			\begin{center}
				...
				\end{tikzpicture}
			\end{center}
			\item \points{1} This follows from the series of equivalences between $f$ and $\tilde{f}$ in the proof of Proposition \ref*{prp:scm_acyclification_properties}. Check this!
