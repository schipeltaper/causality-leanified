...
\JorisDoInput{TODO: check for new definition of intervention node}
...
\begin{Prp}[Interventional ordered local Markov property]
    ...
    \begin{proof}
        This follows from the global Markov property, Theorem \ref{thm-gmp-mCBN}, together with the d-separation statement:
