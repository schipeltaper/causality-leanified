...
\begin{enumerate}[label=\alph*)]
  ...
  \points{If a student interprets a bidirected edge $A \huh B$ as that $A$ and $B$ cause each other (a cycle), zero points (that is so wrong). TODO: rephrase the question (a student answered just: ``I wouldn't consider them equally likeley'').}
