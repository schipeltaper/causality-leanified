...
They originated over a period of four years as a by-product of the course on causality we taught for MSc.\ mathematics students. 
...
\item we have taken lots of care to provide a high level of mathematical rigor and consistency;
\item we emphasize the central role played by the Markov property in the theory.
\end{enumerate}
...
We believe that our treatment fills a gap in the literature on causality, and consider it complementary to the many existing writings on similar topics (which often focus more on concepts and less on mathematical rigor).
