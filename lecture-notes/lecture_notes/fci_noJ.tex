...
%  We know that $i$ is $d$-separated from $k$ given $\Anc_G(\{i,k\})$. 
  ...
  Let $Z \subseteq V \setminus \{i,k\}$ be such that $i \sPerp_G k \given Z$.
  ...
  Because there is no $\sigma$-inducing path between $i$ and $k$ in $G$, Proposition~\ref{prp:sigma-inducing_path_properties} tells us that $i \sPerp_G k \given \Anc_G(\{i,k\}) \setminus \{i,k\}$.
...
\begin{proof}
  ...
  Let $Z \subseteq V \sm \{i,k\}$ be such that $i \sPerp_G k \given Z$.
